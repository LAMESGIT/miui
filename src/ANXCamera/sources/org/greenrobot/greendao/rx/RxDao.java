...
public class RxDao<T, K> extends RxBase {
    ...
    public Observable<List<T>> loadAll() {
        return wrap((Callable) new Callable<List<T>>() {
    ...
    public Observable<Iterable<T>> insertInTx(final Iterable<T> iterable) {
        return wrap((Callable) new Callable<Iterable<T>>() {
    ...
    public Observable<Object[]> insertInTx(final T... tArr) {
        return wrap((Callable) new Callable<Object[]>() {
    ...
    public Observable<Long> count() {
        return wrap((Callable) new Callable<Long>() {
