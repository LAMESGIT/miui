...
public class SDKMonitor implements IHandleOnTimerEvent, IMonitorConfigure, ISendLog {
    ...
    L_0x0004:
        r1 = r9.length();	 Catch:{ all -> 0x00be }
        if (r1 > 0) goto L_0x000c;
    L_0x000a:
        goto L_0x00c0;
    L_0x000c:
        r1 = new java.util.ArrayList;	 Catch:{ all -> 0x00be }
        r1.<init>();	 Catch:{ all -> 0x00be }
        r2 = 0;
        r3 = "report_host_new";
        r3 = r9.optJSONArray(r3);	 Catch:{ Exception -> 0x0040 }
        if (r3 == 0) goto L_0x003f;
    L_0x001a:
        r4 = r3.length();	 Catch:{ Exception -> 0x0040 }
    ...
    L_0x0027:
        r6 = r3.getString(r5);	 Catch:{ Exception -> 0x0040 }
        r7 = android.text.TextUtils.isEmpty(r6);	 Catch:{ Exception -> 0x0040 }
        if (r7 != 0) goto L_0x003c;
    L_0x0031:
        r7 = 46;
        r7 = r6.indexOf(r7);	 Catch:{ Exception -> 0x0040 }
        if (r7 <= 0) goto L_0x003c;
    L_0x0039:
        r1.add(r6);	 Catch:{ Exception -> 0x0040 }
    L_0x003c:
        r5 = r5 + 1;
        goto L_0x0025;
    L_0x003f:
    ...
    L_0x0040:
        r3 = move-exception;
    L_0x0041:
        r3 = r1.isEmpty();	 Catch:{ all -> 0x00be }
        if (r3 != 0) goto L_0x004a;
    L_0x0047:
        r8.mReportUrlList = r1;	 Catch:{ all -> 0x00be }
        goto L_0x004c;
    L_0x004a:
        r8.mReportUrlList = r0;	 Catch:{ all -> 0x00be }
    L_0x004c:
        r0 = "fetch_setting_interval";
        r3 = 1200; // 0x4b0 float:1.682E-42 double:5.93E-321;
        r0 = r9.optLong(r0, r3);	 Catch:{ all -> 0x00be }
        r8.mFetchSettingInterval = r0;	 Catch:{ all -> 0x00be }
        r0 = "polling_interval";
        r1 = 120; // 0x78 float:1.68E-43 double:5.93E-322;
        r0 = r9.optInt(r0, r1);	 Catch:{ all -> 0x00be }
        r8.mReportInterval = r0;	 Catch:{ all -> 0x00be }
        r0 = "once_max_count";
        r1 = 100;
        r0 = r9.optInt(r0, r1);	 Catch:{ all -> 0x00be }
        r8.mReportCount = r0;	 Catch:{ all -> 0x00be }
        r0 = "max_retry_count";
        r1 = 4;
        r0 = r9.optInt(r0, r1);	 Catch:{ all -> 0x00be }
        r8.mReportFailRepeatCount = r0;	 Catch:{ all -> 0x00be }
        r0 = "report_fail_base_time";
        r1 = 15;
        r0 = r9.optInt(r0, r1);	 Catch:{ all -> 0x00be }
        r8.mReportFailBaseTime = r0;	 Catch:{ all -> 0x00be }
        r0 = "log_send_switch";
        r1 = 1;
        r0 = r9.optInt(r0, r1);	 Catch:{ all -> 0x00be }
        r8.mLogSendSwitch = r0;	 Catch:{ all -> 0x00be }
        r0 = "more_channel_stop_interval";
        r3 = 1800; // 0x708 float:2.522E-42 double:8.893E-321;
        r3 = r9.optLong(r0, r3);	 Catch:{ all -> 0x00be }
        r8.mStopMoreChannelInterval = r3;	 Catch:{ all -> 0x00be }
        r0 = "log_remvove_switch";
        r0 = r9.optBoolean(r0, r2);	 Catch:{ all -> 0x00be }
        r8.mLogRemoveSwitch = r0;	 Catch:{ all -> 0x00be }
        r0 = "allow_service_name";
        r0 = r9.optJSONObject(r0);	 Catch:{ all -> 0x00be }
        r8.mAllowService = r0;	 Catch:{ all -> 0x00be }
        r0 = "monitor_encrypt_switch";
        r0 = r9.optBoolean(r0, r1);	 Catch:{ all -> 0x00be }
        r8.mIsEncrypt = r0;	 Catch:{ all -> 0x00be }
        r0 = "monitor_log_max_save_count";
        r1 = 40000; // 0x9c40 float:5.6052E-41 double:1.97626E-319;
        r0 = r9.optLong(r0, r1);	 Catch:{ all -> 0x00be }
        r8.mMonitorMaxRowCount = r0;	 Catch:{ all -> 0x00be }
        r9 = r8.mMonitorManager;	 Catch:{ all -> 0x00be }
        if (r9 == 0) goto L_0x00bc;
    L_0x00b7:
        r9 = r8.mMonitorManager;	 Catch:{ all -> 0x00be }
        r9.updateConfig();	 Catch:{ all -> 0x00be }
    L_0x00bc:
        monitor-exit(r8);
        return;
    L_0x00be:
    ...
    L_0x00c4:
        ...
        throw r9;
        */
        throw new UnsupportedOperationException("Method not decompiled: bytedance.framwork.core.sdkmonitor.SDKMonitor.updateConfig(org.json.JSONObject):void");
    }
    ...
    private String addParamsToURL(String str) {
        ...
        HashMap hashMap = this.mCommonParams;
            ...
            for (Entry entry : hashMap.entrySet()) {
                if (hashMap.get(entry.getKey()) != null) {
                    ...
                    if (str.endsWith("?")) {
                        ...
                        stringBuilder2.append(encode(((String) hashMap.get(entry.getKey())).toString(), "UTF-8"));
