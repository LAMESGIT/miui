...
public final class SingleEquals<T> extends Single<Boolean> {
    ...
    public void subscribeActual(SingleObserver<? super Boolean> singleObserver) {
        ...
        this.first.subscribe(new InnerObserver(0, compositeDisposable2, objArr2, singleObserver2, atomicInteger2));
        this.second.subscribe(new InnerObserver(1, compositeDisposable2, objArr2, singleObserver2, atomicInteger2));
    }
}
