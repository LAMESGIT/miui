...
public abstract class Observable<T> implements ObservableSource<T> {
    ...
    public static Observable<Long> intervalRange(long j, long j2, long j3, long j4, TimeUnit timeUnit, Scheduler scheduler) {
        ...
        if (i < 0) {
            ...
            if (j <= 0 || j5 >= 0) {
                ...
                return RxJavaPlugins.onAssembly(new ObservableIntervalRange(j, j5, Math.max(0, j6), Math.max(0, j4), timeUnit2, scheduler2));
            }
    ...
    public final void subscribe(Observer<? super T> observer) {
        ObjectHelper.requireNonNull(observer, "observer is null");
        try {
            Observer onSubscribe = RxJavaPlugins.onSubscribe(this, (Observer) observer);
    ...
    public final Observable<T> takeLast(long j, long j2, TimeUnit timeUnit, Scheduler scheduler, boolean z, int i) {
        ...
        ObjectHelper.verifyPositive(i2, "bufferSize");
        if (j3 >= 0) {
            return RxJavaPlugins.onAssembly(new ObservableTakeLastTimed(this, j3, j2, timeUnit2, scheduler2, i2, z));
        }
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("count >= 0 required but it was ");
    ...
    public final Observable<Observable<T>> window(long j, long j2, TimeUnit timeUnit, Scheduler scheduler, int i) {
        ...
        TimeUnit timeUnit2 = timeUnit;
        ObjectHelper.requireNonNull(timeUnit2, "unit is null");
        return RxJavaPlugins.onAssembly(new ObservableWindowTimed(this, j3, j4, timeUnit2, scheduler2, Long.MAX_VALUE, i2, false));
    }
