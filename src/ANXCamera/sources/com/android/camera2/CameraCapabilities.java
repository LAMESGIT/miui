...
public class CameraCapabilities {
    ...
    private boolean isSupportedAndroidScalerStream() {
        return "grus".equals(b.pE) && getFacing() == 1;
    }
    ...
    private StreamConfigurationMap getStreamConfigurationMap() {
        ...
        if (this.mStreamConfigurationMap.get(this.mOperatingMode) == null) {
            ...
            } else if (isSupportedQcfa() && this.mCaptureRequestVendorKeys.contains(QCFA_STREAM_CONFIGURATIONS.getName()) && (isQcfaMode() || ((!contains && !isSupportedAndroidScalerStream()) || isUltraPixelPhotographyMode()))) {
