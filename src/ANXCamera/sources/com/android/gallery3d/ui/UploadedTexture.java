            ...
            try {
                ...
                if (width == textureWidth && height == textureHeight) {
                    ...
                    if (this.mBorder > 0) {
                        ...
                        i2 = z2;
                        config = config3;
                        GLUtils.texSubImage2D(3553, 0, 0, 0, getBorderLine(z2, config3, i6), internalFormat, type);
                        GLUtils.texSubImage2D(3553, 0, 0, 0, getBorderLine(i, config, i4), internalFormat, type);
                    } else {
                        i4 = i7;
                        i5 = i6;
                        i2 = z2;
                    ...
                    if (this.mBorder + width < i4) {
                        GLUtils.texSubImage2D(3553, 0, this.mBorder + width, 0, getBorderLine(i2, config, i5), internalFormat, type);
                    }
                    if (this.mBorder + height < i5) {
                        GLUtils.texSubImage2D(3553, 0, 0, this.mBorder + height, getBorderLine(i, config, i4), internalFormat, type);
                    }
                }
                freeBitmap();
