...
public class StickerHelper {
    ...
    public List<StickerInfo> getLocalStick() {
        ...
        StickerInfo stickerInfo = new StickerInfo(null, 2130837908);
        StickerInfo stickerInfo2 = new StickerInfo(getStickerPath(sStickLocal[0]), 2130837903);
        StickerInfo stickerInfo3 = new StickerInfo(getStickerPath(sStickLocal[1]), 2130837904);
