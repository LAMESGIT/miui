...
public class CameraBackupHelper {
    ...
    L_0x009f:
        ...
        r6 = 2131623974; // 0x7f0e0026 float:1.8875115E38 double:1.0531621754E-314;
    ...
    private static List<String> getSettingsKeys() {
        ...
        XmlResourceParser xml = CameraAppImpl.getAndroidContext().getResources().getXml(2131165184);
        try {
