...
public class CameraStat {
    ...
    public static final String PARAM_LIVE_CLICK_PLAY_SHARE_DEFAULT = "live预览分享01";
    ...
    public static void initialize(Context context) {
        ...
        sIsEnabled = resources.getBoolean(2131689483);
        if (sIsEnabled) {
            sIsCounterEventEnabled = resources.getBoolean(2131689484);
