...
public class CameraStatUtil {
    ...
    private static String autoExposureToName(String str) {
        if (str != null) {
            ...
            if (str.equals(resources.getString(2131296525))) {
                return "平均测光";
            }
            if (str.equals(resources.getString(2131296526))) {
                return "中心权重";
            }
            if (str.equals(resources.getString(2131296527))) {
                return "中点测光";
            }
        }
        String str2 = TAG;
    ...
    private static String contrastToName(String str) {
        return pictureQualityToName(2131623957, str);
    }

    private static String saturationToName(String str) {
        return pictureQualityToName(2131623959, str);
    }

    private static String sharpnessToName(String str) {
        return pictureQualityToName(2131623961, str);
    }
    ...
    public static void trackAISceneChanged(int i, int i2, Resources resources) {
        if (!CameraStat.isCounterEventDisabled()) {
            Object obj = "未知";
            TypedArray obtainTypedArray = resources.obtainTypedArray(2131623936);
    ...
    /* JADX WARNING: Removed duplicated region for block: B:44:0x00d1 A:{RETURN} */
    /* JADX WARNING: Removed duplicated region for block: B:45:0x00d2  */
    private static void trackBeautyBodySlim(java.lang.String r5, int r6, com.android.camera.fragment.beauty.BeautyParameters.Type r7) {
        /*
        r0 = new java.util.HashMap;
        r0.<init>();
        r1 = r5.hashCode();
        r2 = 552585030; // 0x20efc746 float:4.0620043E-19 double:2.730132797E-315;
        r3 = 1;
        r4 = 0;
        if (r1 == r2) goto L_0x0021;
    L_0x0011:
        r2 = 957830652; // 0x391755fc float:1.4432514E-4 double:4.732312197E-315;
    ...
    L_0x0047:
        ...
        r0.put(r6, r2);
    L_0x004c:
        r6 = com.android.camera.fragment.beauty.BeautyParameters.Type.HEAD_SLIM_RATIO;
        if (r6 != r7) goto L_0x0053;
    L_0x0050:
        r2 = "头部";
        goto L_0x006e;
    L_0x0053:
        r6 = com.android.camera.fragment.beauty.BeautyParameters.Type.SHOULDER_SLIM_RATIO;
        if (r6 != r7) goto L_0x005a;
    L_0x0057:
        r2 = "肩部";
        goto L_0x006e;
    L_0x005a:
        r6 = com.android.camera.fragment.beauty.BeautyParameters.Type.BODY_SLIM_RATIO;
        if (r6 != r7) goto L_0x0061;
    L_0x005e:
        r2 = "瘦身";
        goto L_0x006e;
    L_0x0061:
        r6 = com.android.camera.fragment.beauty.BeautyParameters.Type.LEG_SLIM_RATIO;
        if (r6 != r7) goto L_0x0068;
    L_0x0065:
        r2 = "长腿";
        goto L_0x006e;
    L_0x0068:
        r6 = com.android.camera.fragment.beauty.BeautyParameters.Type.BEAUTY_RESET;
    ...
    L_0x007b:
        r2 = "beauty_body_slim";
        r6 = "pref_beauty_head_slim_ratio";
        r7 = "pref_beauty_body_slim_ratio";
        r1 = "pref_beauty_shoulder_slim_ratio";
        r3 = "key_beauty_leg_slim_ratio";
        r6 = com.android.camera.CameraSettings.getFaceBeautyRatio(r6, r4);
        r7 = com.android.camera.CameraSettings.getFaceBeautyRatio(r7, r4);
        r1 = com.android.camera.CameraSettings.getFaceBeautyRatio(r1, r4);
        r3 = com.android.camera.CameraSettings.getFaceBeautyRatio(r3, r4);
        r4 = "头部";
        r6 = divideTo10Section(r6);
        r0.put(r4, r6);
        r6 = "肩部";
        r1 = divideTo10Section(r1);
        r0.put(r6, r1);
        r6 = "瘦身";
        r7 = divideTo10Section(r7);
        r0.put(r6, r7);
        r6 = "长腿";
        r7 = divideTo10Section(r3);
        r0.put(r6, r7);
        r6 = "模式";
        r7 = com.android.camera.data.DataRepository.dataItemGlobal();
        r7 = r7.getCurrentMode();
        r7 = modeIdToName(r7);
        r0.put(r6, r7);
    L_0x00cb:
        r6 = android.text.TextUtils.isEmpty(r2);
    ...
    L_0x00d1:
        return;
    L_0x00d2:
        com.android.camera.statistic.CameraStat.recordCountEvent(r5, r2, r0);
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.camera.statistic.CameraStatUtil.trackBeautyBodySlim(java.lang.String, int, com.android.camera.fragment.beauty.BeautyParameters$Type):void");
    }
