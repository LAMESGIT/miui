        ...
        if (i != 166) {
            switch (i) {
                ...
                case 172:
                    break;
                default:
                    this.mItems.add(new ComponentDataItem(2130837882, 2130837882, 0, ULTRA_WIDE_VALUE_OFF));
                    this.mItems.add(new ComponentDataItem(2130837883, 2130837883, 0, ULTRA_WIDE_VALUE_ON));
                    return this.mItems;
            }
        }
        return this.mItems;
