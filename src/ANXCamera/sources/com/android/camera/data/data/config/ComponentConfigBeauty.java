...
public class ComponentConfigBeauty extends ComponentData implements BeautyConstant {
    ...
    private static final boolean sIsLegacyFaceBeauty = b.hM();
    ...
    public ComponentConfigBeauty(DataItemConfig dataItemConfig, int i) {
        ...
        this.mItems.add(new ComponentDataItem(2130837710, 2130837710, 2131296635, SWITCHABLE_BEAUTY_LEVELS[0]));
        this.mItems.add(new ComponentDataItem(2130837710, 2130837709, 2131296635, SWITCHABLE_BEAUTY_LEVELS[1]));
        this.mItems.add(new ComponentDataItem(2130837710, 2130837708, 2131296636, SWITCHABLE_BEAUTY_LEVELS[2]));
    }
