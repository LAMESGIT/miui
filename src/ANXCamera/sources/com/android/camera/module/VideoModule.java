...
public class VideoModule extends VideoBase implements OnErrorListener, OnInfoListener, AutoZoomModuleProtocol, ObjectViewListener, VideoRecordStateCallback {
    ...
    private AutoZoomViewProtocol mAutoZoomViewProtocol;
    ...
    public boolean onBackPressed() {
        ...
        if (this.mMediaRecorderRecording) {
            ...
            if (currentTimeMillis - this.mLastBackPressedTime > 3000) {
                ...
                ToastUtils.showToast(this.mActivity, 2131296546);
            } else {
    ...
    /* JADX WARNING: Missing block: B:13:0x0065, code skipped:
            return;
     */
    ...
    public void readVideoPreferences() {
        ...
        if (CameraSettings.VIDEO_SPEED_FAST.equals(this.mSpeed)) {
            this.mTimeBetweenTimeLapseFrameCaptureMs = Integer.parseInt(DataRepository.dataItemGlobal().getString(CameraSettings.KEY_VIDEO_TIME_LAPSE_FRAME_INTERVAL, getString(2131296311)));
            ...
            if (this.mCaptureTimeLapse) {
                ...
                if (videoQuality < 1000 || videoQuality > 1008) {
                    ...
                    this.mCaptureTimeLapse = false;
                    forceToNormalMode();
                    RotateTextToast.getInstance(this.mActivity).show(2131296548, this.mOrientation);
                }
            }
    ...
    L_0x0023:
        return r1;
    L_0x0024:
        r2 = com.android.camera.CameraSettings.isVideoBokehOn();
        if (r2 == 0) goto L_0x002b;
    L_0x002a:
        return r1;
    L_0x002b:
        r2 = com.android.camera.module.ModuleManager.isFastMotionModule();
        if (r2 != 0) goto L_0x003d;
    L_0x0031:
        r2 = com.android.camera.module.ModuleManager.isSlowMotionModule();
    ...
    L_0x003e:
        return r1;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.camera.module.VideoModule.getHSRValue():int");
    }

    private boolean isUsingUltraWideCamera() {
        return this.mCamera2Device != null && this.mCamera2Device.getId() == Camera2DataContainer.getInstance().getUltraWideCameraId();
    }
    ...
    private void startPreviewSession() {
        ...
        if (isDeviceAlive()) {
            ...
            this.mSurfaceCreatedTimestamp = this.mActivity.getCameraScreenNail().getSurfaceCreatedTimestamp();
            this.mCamera2Device.startPreviewSession(surface, false, false, getOperationModeForPreview(), false, this);
        }
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:56:0x0155  */
    private boolean initializeRecorder(boolean r11) {
        /*
        r10 = this;
        r0 = TAG;
    ...
    L_0x0012:
        r11 = TAG;
        r0 = "initializeRecorder: null host";
        com.android.camera.log.Log.w(r11, r0);
        return r3;
    L_0x001a:
        r10.closeVideoFileDescriptor();
        r10.cleanupEmptyFile();
        r2 = r10.isCaptureIntent();
    ...
    L_0x0026:
        ...
        r10.parseIntent(r2);
    L_0x002f:
        r2 = r10.mVideoFileDescriptor;
        if (r2 != 0) goto L_0x004b;
    L_0x0033:
        r2 = r10.mOutputFormat;
        r4 = r10.mCurrentFileNumber;
        r5 = r10.isFPS960();
        r11 = r10.genContentValues(r2, r4, r5, r11);
        r10.mCurrentVideoValues = r11;
        r11 = r10.mCurrentVideoValues;
        r2 = "_data";
        r11 = r11.getAsString(r2);
        r10.mCurrentVideoFilename = r11;
    L_0x004b:
        r11 = r10.mStopRecorderDone;
        if (r11 == 0) goto L_0x007c;
    L_0x004f:
        r4 = java.lang.System.currentTimeMillis();
        r11 = r10.mStopRecorderDone;	 Catch:{ InterruptedException -> 0x005d }
        r6 = 1000; // 0x3e8 float:1.401E-42 double:4.94E-321;
        r2 = java.util.concurrent.TimeUnit.MILLISECONDS;	 Catch:{ InterruptedException -> 0x005d }
        r11.await(r6, r2);	 Catch:{ InterruptedException -> 0x005d }
        goto L_0x0061;
    L_0x005d:
        r11 = move-exception;
        r11.printStackTrace();
    L_0x0061:
        ...
        r2.<init>();
        r6 = "initializeRecorder: waitTime=";
        r2.append(r6);
        r6 = java.lang.System.currentTimeMillis();
        r6 = r6 - r4;
        r2.append(r6);
        r2 = r2.toString();
        com.android.camera.log.Log.d(r11, r2);
    L_0x007c:
        r4 = java.lang.System.currentTimeMillis();
        r11 = r10.mLock;
        monitor-enter(r11);
        r2 = r10.mMediaRecorder;	 Catch:{ all -> 0x017a }
        if (r2 != 0) goto L_0x0090;
    L_0x0088:
        r2 = new android.media.MediaRecorder;	 Catch:{ all -> 0x017a }
        r2.<init>();	 Catch:{ all -> 0x017a }
        r10.mMediaRecorder = r2;	 Catch:{ all -> 0x017a }
        goto L_0x00b4;
    L_0x0090:
        r2 = r10.mMediaRecorder;	 Catch:{ all -> 0x017a }
        r2.reset();	 Catch:{ all -> 0x017a }
        r2 = DEBUG;	 Catch:{ all -> 0x017a }
        if (r2 == 0) goto L_0x00b4;
    L_0x0099:
        r2 = TAG;	 Catch:{ all -> 0x017a }
        r6 = new java.lang.StringBuilder;	 Catch:{ all -> 0x017a }
        r6.<init>();	 Catch:{ all -> 0x017a }
        r7 = "initializeRecorder: t1=";
        r6.append(r7);	 Catch:{ all -> 0x017a }
        r7 = java.lang.System.currentTimeMillis();	 Catch:{ all -> 0x017a }
        r7 = r7 - r4;
        r6.append(r7);	 Catch:{ all -> 0x017a }
        r4 = r6.toString();	 Catch:{ all -> 0x017a }
        com.android.camera.log.Log.v(r2, r4);	 Catch:{ all -> 0x017a }
    L_0x00b4:
        monitor-exit(r11);	 Catch:{ all -> 0x017a }
        r11 = 0;
        r2 = 1;
        r4 = r10.mMediaRecorder;	 Catch:{ Exception -> 0x012f }
        r10.setupRecorder(r4);	 Catch:{ Exception -> 0x012f }
        r4 = r10.mVideoFileDescriptor;	 Catch:{ Exception -> 0x012f }
        if (r4 == 0) goto L_0x00cc;
    L_0x00c0:
        r4 = r10.mMediaRecorder;	 Catch:{ Exception -> 0x012f }
        r5 = r10.mVideoFileDescriptor;	 Catch:{ Exception -> 0x012f }
        r5 = r5.getFileDescriptor();	 Catch:{ Exception -> 0x012f }
        r4.setOutputFile(r5);	 Catch:{ Exception -> 0x012f }
        goto L_0x00ea;
    L_0x00cc:
        r4 = com.android.camera.storage.Storage.isUseDocumentMode();	 Catch:{ Exception -> 0x012f }
        if (r4 != 0) goto L_0x00da;
    L_0x00d2:
        r4 = r10.mMediaRecorder;	 Catch:{ Exception -> 0x012f }
        r5 = r10.mCurrentVideoFilename;	 Catch:{ Exception -> 0x012f }
        r4.setOutputFile(r5);	 Catch:{ Exception -> 0x012f }
        goto L_0x00ea;
    L_0x00da:
        r4 = r10.mCurrentVideoFilename;	 Catch:{ Exception -> 0x012f }
        r4 = com.android.camera.FileCompat.getParcelFileDescriptor(r4, r2);	 Catch:{ Exception -> 0x012f }
        r11 = r10.mMediaRecorder;	 Catch:{ Exception -> 0x012a, all -> 0x0127 }
        r5 = r4.getFileDescriptor();	 Catch:{ Exception -> 0x012a, all -> 0x0127 }
        r11.setOutputFile(r5);	 Catch:{ Exception -> 0x012a, all -> 0x0127 }
        r11 = r4;
    L_0x00ea:
        r4 = r10.mMediaRecorder;	 Catch:{ Exception -> 0x012f }
        r5 = r10.mRecorderSurface;	 Catch:{ Exception -> 0x012f }
        r4.setInputSurface(r5);	 Catch:{ Exception -> 0x012f }
        r4 = java.lang.System.currentTimeMillis();	 Catch:{ Exception -> 0x012f }
        r6 = r10.mMediaRecorder;	 Catch:{ Exception -> 0x012f }
        r6.prepare();	 Catch:{ Exception -> 0x012f }
        r6 = r10.mMediaRecorder;	 Catch:{ Exception -> 0x012f }
        r6.setOnErrorListener(r10);	 Catch:{ Exception -> 0x012f }
        r6 = r10.mMediaRecorder;	 Catch:{ Exception -> 0x012f }
        r6.setOnInfoListener(r10);	 Catch:{ Exception -> 0x012f }
        r6 = DEBUG;	 Catch:{ Exception -> 0x012f }
        if (r6 == 0) goto L_0x0123;
    L_0x0108:
        r6 = TAG;	 Catch:{ Exception -> 0x012f }
        r7 = new java.lang.StringBuilder;	 Catch:{ Exception -> 0x012f }
        r7.<init>();	 Catch:{ Exception -> 0x012f }
        r8 = "initializeRecorder: t2=";
        r7.append(r8);	 Catch:{ Exception -> 0x012f }
        r8 = java.lang.System.currentTimeMillis();	 Catch:{ Exception -> 0x012f }
        r8 = r8 - r4;
        r7.append(r8);	 Catch:{ Exception -> 0x012f }
        r4 = r7.toString();	 Catch:{ Exception -> 0x012f }
        com.android.camera.log.Log.v(r6, r4);	 Catch:{ Exception -> 0x012f }
    L_0x0123:
        com.android.camera.Util.closeSilently(r11);
        goto L_0x0151;
    L_0x0127:
        r0 = move-exception;
        r11 = r4;
    ...
    L_0x012f:
        r2 = move-exception;
    L_0x0130:
        r4 = TAG;	 Catch:{ all -> 0x012d }
        r5 = new java.lang.StringBuilder;	 Catch:{ all -> 0x012d }
        r5.<init>();	 Catch:{ all -> 0x012d }
        r6 = "prepare failed for ";
        r5.append(r6);	 Catch:{ all -> 0x012d }
        r6 = r10.mCurrentVideoFilename;	 Catch:{ all -> 0x012d }
        r5.append(r6);	 Catch:{ all -> 0x012d }
        r5 = r5.toString();	 Catch:{ all -> 0x012d }
        com.android.camera.log.Log.e(r4, r5, r2);	 Catch:{ all -> 0x012d }
        r10.releaseMediaRecorder();	 Catch:{ all -> 0x012d }
        com.android.camera.Util.closeSilently(r11);
        r2 = r3;
    L_0x0151:
        r11 = DEBUG;
    ...
    L_0x0155:
        r11 = r10.mRecorderSurface;
        r10.showSurfaceInfo(r11);
    L_0x015a:
        r11 = TAG;
        r3 = new java.lang.StringBuilder;
        r3.<init>();
        r4 = "initializeRecorder<<time=";
        r3.append(r4);
        r4 = java.lang.System.currentTimeMillis();
        r4 = r4 - r0;
        r3.append(r4);
        r0 = r3.toString();
        com.android.camera.log.Log.d(r11, r0);
        return r2;
    L_0x0176:
        com.android.camera.Util.closeSilently(r11);
        throw r0;
    L_0x017a:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.camera.module.VideoModule.initializeRecorder(boolean):boolean");
    }
    ...
    private void setupRecorder(MediaRecorder mediaRecorder) throws FileNotFoundException {
        ...
        int i = (isNormalMode || isHFRMode || isFPS120() || isFPS240()) ? true : 0;
        ...
        if (hSRValue > 0) {
            ...
            stringBuilder.append("setVideoFrameRate: ");
            stringBuilder.append(hSRValue);
            Log.d(str, stringBuilder.toString());
        } else {
            ...
            stringBuilder = new StringBuilder();
            stringBuilder.append("setVideoFrameRate: ");
            stringBuilder.append(this.mProfile.videoFrameRate);
            Log.d(str, stringBuilder.toString());
        }
            ...
            switch (i) {
                ...
                case 801:
                    ...
                    if (!this.mActivity.getScreenHint().isScreenHintVisible()) {
                        Toast.makeText(this.mActivity, 2131296459, 1).show();
                        break;
                    }
                    break;
                case 802:
    ...
    private boolean startRecorder() {
        ...
        try {
            ...
            if (e instanceof IllegalStateException) {
                showConfirmMessage(2131296638, 2131296640);
            }
            return false;
        }
    }
    ...
    public void stopVideoRecording(boolean z, boolean z2) {
        ...
        if (this.mMediaRecorderRecording && (!isFPS960() || !this.mMediaRecorderPostProcessing)) {
            ...
            } else if (FragmentTopAlert.HINT_DELAY_TIME - (SystemClock.uptimeMillis() - this.mRecordingStartTime) > 100) {
                this.mMediaRecorderRecording = false;
            } else {
            ...
            if (this.mCamera2Device == null || ModuleManager.isVideoNewSlowMotion()) {
                ...
                j = currentTimeMillis;
                CameraStatUtil.trackVideoRecorded(isFrontCamera(), getModuleIndex(), DataRepository.dataItemRunning().isSwitchOn("pref_camera_auto_zoom"), CameraSettings.isUltraWideConfigOpen(getModuleIndex()), this.mSpeed, this.mQuality, this.mCamera2Device.getFlashMode(), this.mFrameRate, this.mTimeBetweenTimeLapseFrameCaptureMs, this.mBeautyValues, this.mVideoRecordTime);
            ...
            stringBuilder2.append(System.currentTimeMillis() - j);
            Log.v(str2, stringBuilder2.toString());
        }
    }
     ...
     */
    /* JADX WARNING: Missing block: B:15:0x0071, code skipped:
            com.android.camera.log.Log.e(TAG, "960fps processing failed. delete the files.");
            r1.delete();
            r2.delete();
     */
    /* JADX WARNING: Missing block: B:20:0x0089, code skipped:
            if (null != null) goto L_0x008c;
     */
    ...
    /* JADX WARNING: Missing block: B:23:0x0093, code skipped:
            return r0;
     */
    private java.lang.String postProcessVideo(java.lang.String r9) {
        /*
        r8 = this;
        r0 = 0;
    ...
    L_0x0003:
        ...
        r3 = new java.io.File;
        r4 = r1.getName();
        r4 = com.android.camera.storage.Storage.generatePrimaryFilepath(r4);
        r3.<init>(r4);
        r4 = 0;
        r5 = r1.getAbsolutePath();	 Catch:{ Throwable -> 0x0081 }
        r6 = r2.getAbsolutePath();	 Catch:{ Throwable -> 0x0081 }
        r7 = com.android.camera.data.DataRepository.dataItemFeature();	 Catch:{ Throwable -> 0x0081 }
        r7 = r7.fD();	 Catch:{ Throwable -> 0x0081 }
        r5 = com.miui.extravideo.interpolation.VideoInterpolator.doDecodeAndEncodeSync(r5, r6, r7);	 Catch:{ Throwable -> 0x0081 }
        if (r5 == 0) goto L_0x004c;
    L_0x0044:
        r5 = r2.renameTo(r3);	 Catch:{ Throwable -> 0x0081 }
        if (r5 == 0) goto L_0x004c;
    L_0x004a:
        r4 = 1;
    L_0x004c:
        r5 = r8.isDump960Orig();	 Catch:{ Throwable -> 0x0081 }
        if (r5 == 0) goto L_0x006c;
    L_0x0052:
        r5 = new java.io.File;	 Catch:{ Throwable -> 0x0081 }
        r6 = new java.lang.StringBuilder;	 Catch:{ Throwable -> 0x0081 }
        r6.<init>();	 Catch:{ Throwable -> 0x0081 }
        r6.append(r9);	 Catch:{ Throwable -> 0x0081 }
        r9 = ".orig.mp4";
        r6.append(r9);	 Catch:{ Throwable -> 0x0081 }
        r9 = r6.toString();	 Catch:{ Throwable -> 0x0081 }
        r5.<init>(r9);	 Catch:{ Throwable -> 0x0081 }
        r1.renameTo(r5);	 Catch:{ Throwable -> 0x0081 }
        goto L_0x006f;
    L_0x006c:
    ...
    L_0x0071:
        ...
        com.android.camera.log.Log.e(r9, r5);
        r1.delete();
        r2.delete();
        goto L_0x008c;
    L_0x007f:
    ...
    L_0x0081:
        r9 = move-exception;
        r5 = TAG;	 Catch:{ all -> 0x007f }
        r6 = "960fps processing failed.";
        com.android.camera.log.Log.e(r5, r6, r9);	 Catch:{ all -> 0x007f }
        if (r4 != 0) goto L_0x008c;
    L_0x008b:
        goto L_0x0071;
    L_0x008c:
    ...
    public boolean onGestureTrack(RectF rectF, boolean z) {
        if (this.mInStartingFocusRecording || !isBackCamera() || !b.gE() || CameraSettings.is4KHigherVideoQuality(this.mQuality) || isCaptureIntent()) {
            return false;
        }
    ...
    L_0x003d:
        ...
        r2 = 2131296693; // 0x7f0901b5 float:1.821131E38 double:1.053000477E-314;
        r0.show(r2, r1);
        return r1;
    L_0x0051:
    ...
    public boolean enableFaceDetection() {
        return (isHFRMode() || isSlowMode() || ModuleManager.isVideoNewSlowMotion() || !DataRepository.dataItemGlobal().getBoolean(CameraSettings.KEY_FACE_DETECTION, getResources().getBoolean(2131689478))) ? false : true;
    }
    ...
    private void updateFpsRange() {
        if (isDeviceAlive()) {
            ...
            if (isHFRMode() || isSlowMode() || ModuleManager.isVideoNewSlowMotion()) {
                ...
                int i = 0;
                Object obj = supportedFpsRange[0];
                int length = supportedFpsRange.length;
                while (i < length) {
                    Range range = supportedFpsRange[i];
                    int hSRValue = getHSRValue();
                    if (hSRValue == 60) {
                        obj = new Range(Integer.valueOf(hSRValue), Integer.valueOf(hSRValue));
                        break;
                    }
                    if (((Integer) obj.getUpper()).intValue() < ((Integer) range.getUpper()).intValue() || (obj.getUpper() == range.getUpper() && ((Integer) obj.getLower()).intValue() < ((Integer) range.getLower()).intValue())) {
                        obj = range;
                    }
                    i++;
                }
                ...
                Log.d(str, stringBuilder.toString());
                this.mCamera2Device.setFpsRange(obj);
                this.mCamera2Device.setVideoFpsRange(obj);
            }
        }
    }
        ...
        this.mAutoZoomUiDisposable = Observable.timer(1000, TimeUnit.MILLISECONDS).observeOn(AndroidSchedulers.mainThread()).subscribe(new Consumer<Long>() {
            public void accept(Long l) throws Exception {
                if (!VideoModule.this.isAutoZoomTracking.get()) {
                    VideoModule.this.mTopAlert.alertAiDetectTipHint(0, 2131296898, -1);
                }
            }
        });
    }
    ...
    private int getOperationModeForPreview() {
        if (DataRepository.dataItemRunning().isSwitchOn("pref_camera_auto_zoom")) {
            return CameraCapabilities.SESSION_OPERATION_MODE_AUTO_ZOOM;
        }
        return 0;
