...
public class CameraTestManager {
    ...
    protected final int FOCUS_AREA_HEIGHT = CameraAppImpl.getAndroidContext().getResources().getDimensionPixelSize(2131361801);
    protected final int FOCUS_AREA_WIDTH = CameraAppImpl.getAndroidContext().getResources().getDimensionPixelSize(2131361800);
     ...
     */
        ...
        L_0x0042:
            throw r1;
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.camera.module.loader.camera2.CameraTestManager$AnonymousClass4.onImageAvailable(android.media.ImageReader):void");
        }
    };
