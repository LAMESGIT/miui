...
public class FocusManager2 extends FocusManagerAbstract {
    ...
    public void prepareCapture(boolean z, int i) {
        if (this.mInitialized) {
            ...
            int i2 = 0;
            int i3 = (i != 2 || (!("auto".equals(focusMode) || AutoFocus.LEGACY_MACRO.equals(focusMode)) || (this.mLastState != 3 && z))) ? true : 0;
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            ...
            if (!(!isFocusEnabled() || equals || i3 == 0)) {
                ...
                } else if (!(!z || this.mCameraFocusArea == null || b.gA())) {
