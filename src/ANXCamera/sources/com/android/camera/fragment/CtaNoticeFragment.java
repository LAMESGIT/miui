...
public class CtaNoticeFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        Builder negativeButton = new Builder(getActivity()).setTitle(2131296746).setMessage(buildUserNotice(getActivity(), 2131296744)).setPositiveButton(2131296742, new OnClickListener() {
        ...
        if (this.mShowRemindButton) {
            negativeButton.setCheckBox(true, getActivity().getString(2131296743));
        }
    ...
    private static SpannableStringBuilder buildUserNotice(final Context context, int i) {
        ...
        String string = resources.getString(2131296740);
        String string2 = resources.getString(2131296741);
        String string3 = resources.getString(i, new Object[]{string, string2});
        AnonymousClass3 anonymousClass3 = new UrlSpanOnClickListener() {
            public void onClick() {
                context.startActivity(Licence.getUserAgreementIntent());
            }
        };
        AnonymousClass4 anonymousClass4 = new UrlSpanOnClickListener() {
            public void onClick() {
