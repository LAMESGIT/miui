...
public class FragmentLiveMusic extends DialogFragment implements OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        View inflate = layoutInflater.inflate(2130968593, viewGroup, false);
        initView(inflate);
        return inflate;
    }
    ...
    public void initView(View view) {
        this.mHotMusicText = (TextView) view.findViewById(2131558467);
        this.mHotMusicText.setOnClickListener(this);
        this.mLocalMusicText = (TextView) view.findViewById(2131558468);
        this.mLocalMusicText.setOnClickListener(this);
        this.mCloseImageView = (ImageView) view.findViewById(2131558466);
        this.mCloseImageView.setOnClickListener(this);
        this.mViewPager = (ViewPager) view.findViewById(2131558469);
    ...
    private void onClickOnline() {
        int color = ContextCompat.getColor(getContext(), 2131427418);
