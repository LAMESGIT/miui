...
public class FragmentLiveMusicPager extends Fragment implements OnClickListener, OnTouchListener, OnCtaNoticeClickListener {
        ...
        public void onFailed() {
            ...
            Completable.fromAction(new Action() {
                public void run() {
                    ...
                    Toast.makeText(FragmentLiveMusicPager.this.getActivity(), 2131296877, 1).show();
                }
    ...
    public View onCreateView(LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        View inflate = layoutInflater.inflate(2130968605, viewGroup, false);
        initView(inflate);
        return inflate;
    }
    ...
    public void initView(View view) {
        this.mRecyclerView = (RecyclerView) view.findViewById(2131558493);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getContext());
        linearLayoutManager.setOrientation(1);
        this.mRecyclerView.setLayoutManager(linearLayoutManager);
        this.mRecyclerView.setItemAnimator(new DefaultItemAnimator());
        this.mUpdateLayout = (LinearLayout) view.findViewById(2131558492);
        this.mNetworkExceptionLayout = (LinearLayout) view.findViewById(2131558494);
    ...
    public void setUserVisibleHint(boolean z) {
        ...
        if (!z && this.mMediaPlayer != null && this.mMediaPlayer.isPlaying()) {
            ...
            this.mPlayingImageView.setBackgroundResource(2130837772);
        }
    }
    ...
    public void onClick(View view) {
        ...
        if (id == 2131558494) {
            ...
            this.mNetworkExceptionLayout.setVisibility(8);
            loadOnlineHotMusic();
        } else if (id == 2131558543 && !this.mIsMediaPreparing) {
            ...
            if (this.mItemType == 0 && !NetworkDependencies.isConnected(getContext())) {
                ...
                if (new File(stringBuilder2).exists()) {
                    ...
                    Toast.makeText(getActivity(), 2131296877, 1).show();
                    return;
                }
            }
            ...
            ImageView imageView = (ImageView) view.findViewById(2131558543);
            if (!imageView.equals(this.mPlayingImageView)) {
                this.mPlayingImageView = imageView;
            }
            this.mMediaLoadingProgressBar = (ProgressBar) ((ViewGroup) view.getParent()).findViewById(2131558544);
            startPlayMusic(liveMusicInfo);
        }
    }

    public boolean onTouch(View view, MotionEvent motionEvent) {
        this.mCurrentSelectedMusicLayout = (LinearLayout) view.findViewById(2131558541);
            ...
            try {
                ...
                this.mMediaPlayer.setOnPreparedListener(new OnPreparedListener() {
                    public void onPrepared(MediaPlayer mediaPlayer) {
                        ...
                        FragmentLiveMusicPager.this.mPlayingImageView.setBackgroundResource(2130837771);
                        mediaPlayer.start();
                ...
                this.mMediaPlayer.setOnCompletionListener(new OnCompletionListener() {
                    public void onCompletion(MediaPlayer mediaPlayer) {
                        ...
                        FragmentLiveMusicPager.this.mPlayingImageView.setBackgroundResource(2130837772);
                    }
                });
            } catch (IOException e) {
                String str = TAG;
    ...
    private void startDownloadAnimation() {
        ...
        String string = getString(2131296876);
