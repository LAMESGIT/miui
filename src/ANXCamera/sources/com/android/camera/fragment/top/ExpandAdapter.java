...
public class ExpandAdapter extends Adapter<CommonRecyclerViewHolder> implements OnClickListener {
    ...
    public CommonRecyclerViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return new CommonRecyclerViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(2130968632, viewGroup, false));
    }
    ...
    public void onBindViewHolder(CommonRecyclerViewHolder commonRecyclerViewHolder, int i) {
        ...
        final TextView textView = (TextView) commonRecyclerViewHolder.getView(2131558598);
        ...
        if (this.mCurrentValue.equals(componentDataItem.mValue)) {
            ...
            if (Util.isAccessible()) {
                final String string = commonRecyclerViewHolder.itemView.getResources().getString(2131296494);
