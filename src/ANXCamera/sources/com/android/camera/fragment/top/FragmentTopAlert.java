...
public class FragmentTopAlert extends BaseFragment {
            ...
            if (FragmentTopAlert.this.isAdded()) {
                ...
                if (FragmentTopAlert.this.mAiSceneSwitchHintText.getVisibility() != 8) {
                    ...
                    if (!(FragmentTopAlert.this.mAlertImageView.getVisibility() == 0 || FragmentTopAlert.this.mAlertTopHintText.getVisibility() == 0)) {
                        ...
                        TextView access$400 = FragmentTopAlert.this.mAlertStatusValue;
    ...
    public void initView(View view) {
        this.mAlertImageView = (ImageView) view.findViewById(2131558561);
        this.mAlertRecordingText = (TextView) view.findViewById(2131558559);
        this.mAlertStatusValue = (TextView) view.findViewById(2131558568);
        this.mAiSceneSelectView = (ToggleSwitch) view.findViewById(2131558569);
        this.mAiSceneSwitchHintText = (TextView) view.findViewById(2131558562);
        this.mAlertTopHintText = (TextView) view.findViewById(2131558563);
        this.mAlertLiearLayout = (LinearLayout) view.findViewById(2131558560);
        this.mAlertAiDetectHintTv = (TextView) view.findViewById(2131558564);
        this.mLiveMusiHintText = (TextView) view.findViewById(2131558566);
        this.mLiveMusicHintLayout = (LinearLayout) view.findViewById(2131558565);
        this.mLiveMusicClose = (ImageView) this.mLiveMusicHintLayout.findViewById(2131558567);
    ...
    private void showCloseConfirm() {
        ...
        builder.setMessage(2131296879);
        builder.setCancelable(false);
        builder.setPositiveButton(2131296880, new DialogInterface.OnClickListener() {
        ...
        builder.setNegativeButton(2131296881, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialogInterface, int i) {
            }
        });
        builder.show();
    ...
    public void alertHDR(int i, int i2, boolean z) {
        ...
        if (i == 0) {
            ...
            if (this.mAlertImageType != i3) {
                ...
                this.mAlertImageView.setImageResource(z ? 2130837691 : 2130837690);
            } else {
                return;
            }
    ...
    public void alertFlash(int i, int i2, boolean z) {
        ...
        if (i == 0) {
            ...
            if (this.mAlertImageType != i3) {
                ...
                this.mAlertImageView.setImageResource(z ? 2130837689 : 2130837688);
            } else {
                return;
            }
    ...
    public void alertAiSceneSelector(int i, int i2) {
        alertAiSceneSelector(getResources().getString(2131296764), getResources().getString(2131296765), i, i2, i == 0 ? new OnCheckedChangeListener() {
    ...
    public void alertLightingTitle(boolean z, int i) {
        if (z) {
            ...
            this.mAiSceneSwitchHintText.setText(2131296770);
            this.mAiSceneSwitchHintText.setVisibility(0);
            this.mAiSceneSwitchHintText.removeCallbacks(this.mViewHideRunnable);
            this.mAiSceneSwitchHintText.postDelayed(this.mViewHideRunnable, HINT_DELAY_TIME);
    ...
    private int getAlertImageBottom() {
        ...
        int dimensionPixelSize = getResources().getDimensionPixelSize(2131361984);
        int dimensionPixelSize2 = getResources().getDimensionPixelSize(2131361985);
        ...
        return ((((MarginLayoutParams) this.mAlertImageView.getLayoutParams()).topMargin + this.mAlertImageView.getDrawable().getIntrinsicHeight()) + getResources().getDimensionPixelSize(2131361825)) - getResources().getDimensionPixelSize(2131361958);
    }
    ...
    private int getViewBottom(View view) {
        ...
        return ((marginLayoutParams.topMargin + dimensionPixelSize2) + getResources().getDimensionPixelSize(2131361825)) - getResources().getDimensionPixelSize(2131361958);
    }
