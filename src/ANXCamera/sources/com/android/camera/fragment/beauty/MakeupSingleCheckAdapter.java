...
public class MakeupSingleCheckAdapter extends Adapter<SingleCheckViewHolder> {
    ...
    class SingleCheckViewHolder extends ViewHolder implements OnClickListener {
        ...
        public SingleCheckViewHolder(View view, MakeupSingleCheckAdapter makeupSingleCheckAdapter) {
            ...
            this.itemView = view;
            this.mText = (TextView) view.findViewById(2131558411);
            this.mBase = (ColorImageView) view.findViewById(2131558410);
        ...
        public void setDataToView(MakeupItem makeupItem, int i) throws Exception {
            ...
            textView.setTextColor(i == access$500 ? ColorConstant.COLOR_COMMON_SELECTED : resources.getColor(2131427419));
            if (Util.isAccessible()) {
                ...
                if (i == MakeupSingleCheckAdapter.this.mSelectedItem) {
                    ...
                    stringBuilder2.append(resources.getString(2131296495));
                    stringBuilder = stringBuilder2.toString();
                } else {
                    stringBuilder2 = new StringBuilder();
                    stringBuilder2.append(resources.getString(makeupItem.getTextResource()));
                    stringBuilder2.append(resources.getString(2131296496));
                    stringBuilder = stringBuilder2.toString();
                }
            ...
            if (i != MakeupSingleCheckAdapter.this.mSelectedItem) {
                i2 = resources.getColor(2131427417);
            }
        ...
        public void onClick(View view) {
            ...
            if (singleCheckViewHolder != null) {
                colorAnimate(singleCheckViewHolder.mBase, ColorConstant.COLOR_COMMON_SELECTED, resources.getColor(2131427417));
            }
            if (singleCheckViewHolder2 != null) {
                colorAnimate(singleCheckViewHolder2.mBase, resources.getColor(2131427417), ColorConstant.COLOR_COMMON_SELECTED);
            }
            if (singleCheckViewHolder != null) {
                textColorAnimate(singleCheckViewHolder.mText, ColorConstant.COLOR_COMMON_SELECTED, resources.getColor(2131427419));
            }
            if (singleCheckViewHolder2 != null) {
                textColorAnimate(singleCheckViewHolder2.mText, resources.getColor(2131427419), ColorConstant.COLOR_COMMON_SELECTED);
            }
            if (singleCheckViewHolder == null) {
    ...
    public SingleCheckViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return new SingleCheckViewHolder(LayoutInflater.from(this.mContext).inflate(2130968636, viewGroup, false), this);
    }
