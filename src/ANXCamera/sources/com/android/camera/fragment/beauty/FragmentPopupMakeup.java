...
public class FragmentPopupMakeup extends BaseFragment implements MakeupProtocol, Consumer<Integer> {
    ...
    public void initView(View view) {
        ...
        this.mSeekBar = (SeekBarCompat) view.findViewById(2131558550);
        ...
        this.mSeekBar.setProgressDrawable(getResources().getDrawable(2130837962));
    ...
    public void setSeekBarMode(int i) {
        ...
        switch (i) {
            ...
            case 2:
                ...
                this.mSeekBar.setProgressDrawable(getResources().getDrawable(2130837540));
                z = true;
                break;
        }
