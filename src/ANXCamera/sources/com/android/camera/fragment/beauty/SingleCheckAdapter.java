...
public class SingleCheckAdapter extends Adapter<SingleCheckViewHolder> {
    ...
    class SingleCheckViewHolder extends ViewHolder implements OnClickListener {
        ...
        public SingleCheckViewHolder(View view, SingleCheckAdapter singleCheckAdapter) {
            ...
            this.mText = (TextView) view.findViewById(2131558413);
            this.mBase = (ColorImageView) view.findViewById(2131558412);
        ...
        public void setDateToView(LevelItem levelItem, int i) throws Exception {
            if (TextUtils.isEmpty(levelItem.mText)) {
                ...
                this.mText.setTextSize(0, (float) SingleCheckAdapter.this.mContext.getResources().getDimensionPixelSize(2131362001));
            ...
            if (i == 0) {
                ...
                if (i == SingleCheckAdapter.this.mSelectedItem) {
                    string = SingleCheckAdapter.this.mContext.getString(2131296498);
                } else {
                    string = SingleCheckAdapter.this.mContext.getString(2131296497);
                }
            ...
            if (i == SingleCheckAdapter.this.mSelectedItem) {
                ...
                stringBuilder.append(SingleCheckAdapter.this.mContext.getString(2131296495));
                string = stringBuilder.toString();
            } else {
                stringBuilder = new StringBuilder();
                stringBuilder.append(i);
                stringBuilder.append(SingleCheckAdapter.this.mContext.getString(2131296496));
                string = stringBuilder.toString();
            }
            textView.setContentDescription(string);
        }
    ...
    public SingleCheckAdapter(Context context, List<LevelItem> list, int i) {
        ...
        this.mColorNormal = context.getResources().getColor(2131427392);
        this.mColorSelected = context.getResources().getColor(2131427416);
    ...
    public SingleCheckViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return new SingleCheckViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(2130968577, viewGroup, false), this);
    }
