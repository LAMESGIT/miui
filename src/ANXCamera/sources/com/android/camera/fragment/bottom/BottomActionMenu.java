...
public class BottomActionMenu {
    ...
    private void initView(FrameLayout frameLayout) {
        ...
        this.mCameraOperateMenuView = (EdgeHorizonScrollView) this.mContainerView.findViewById(2131558431);
        this.mCameraOperateSelectView = (ModeSelectView) this.mContainerView.findViewById(2131558432);
        switchMenuMode(0, false);
    }

    public void initBeautyMenuView() {
        if (this.mBeautyOperateMenuView == null) {
            LinearLayout linearLayout = (LinearLayout) this.mContainerView.findViewById(2131558430);
