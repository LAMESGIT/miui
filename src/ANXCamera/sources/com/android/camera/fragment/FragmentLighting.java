...
public class FragmentLighting extends BaseFragment implements OnClickListener {
    ...
    private static class LightingAdapter extends Adapter<CommonRecyclerViewHolder> {
        ...
        public LightingAdapter(Context context, int i, OnClickListener onClickListener, ComponentRunningLighting componentRunningLighting) {
            ...
            this.mMargin = context.getResources().getDimensionPixelSize(2131361989);
            this.mBgNormal = context.getResources().getDrawable(2130837507);
            this.mBgSelected = context.getResources().getDrawable(2130837508);
        ...
        public CommonRecyclerViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            return new CommonRecyclerViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(2130968604, viewGroup, false));
        }
        ...
        public void onBindViewHolder(CommonRecyclerViewHolder commonRecyclerViewHolder, int i) {
            ...
            ColorImageView colorImageView = (ColorImageView) commonRecyclerViewHolder.getView(2131558490);
            ColorImageView colorImageView2 = (ColorImageView) commonRecyclerViewHolder.getView(2131558491);
    ...
    public void initView(View view) {
        this.mRecyclerView = (RecyclerView) view.findViewById(2131558489);
        ...
        this.mHolderWidth = getResources().getDimensionPixelSize(2131361988);
        try {
