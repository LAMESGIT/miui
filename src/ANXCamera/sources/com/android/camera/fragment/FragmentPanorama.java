...
public class FragmentPanorama extends BaseFragment implements OnClickListener, RequestRenderListener, PanoramaProtocol {
    ...
    public void initView(View view) {
        ...
        this.mIndicator = (ImageView) this.mPanoramaViewRoot.findViewById(2131558607);
        this.mUseHint = (TextView) this.mPanoramaViewRoot.findViewById(2131558609);
        this.mIndicator.setImageDrawable(this.mPanoramaArrowAnimateDrawable);
        this.mArrowMargin = getResources().getDimensionPixelSize(2131361807);
        if (Util.isNotchDevice) {
            setViewMargin(this.mPanoramaViewRoot, Util.sStatusBarHeight);
        }
        this.mPanoramaPreview = (ImageView) this.mPanoramaViewRoot.findViewById(2131558604);
        this.mStillPreview = (GLTextureView) this.mPanoramaViewRoot.findViewById(2131558606);
        this.mMovingDirectionView = (PanoMovingIndicatorView) this.mPanoramaViewRoot.findViewById(2131558610);
        this.mMoveReferenceLine = this.mPanoramaViewRoot.findViewById(2131558603);
        this.mStillPreviewHintArea = this.mPanoramaViewRoot.findViewById(2131558605);
        this.mHintFrame = (ViewGroup) this.mPanoramaViewRoot.findViewById(2131558602);
    ...
    public void initPreviewLayout(int i, int i2, int i3, int i4) {
        ...
        this.mUseHint.setText(2131296461);
    }
    ...
    public void onPreviewMoving() {
        ...
        if (this.mMovingDirectionView.isTooFast()) {
            this.mUseHint.setText(2131296657);
        } else if (this.mMovingDirectionView.isFar()) {
            this.mUseHint.setText(2131296656);
        } else {
            this.mUseHint.setText(2131296460);
        }
    }
