...
public class HibernationFragment extends DialogFragment implements OnKeyListener, OnClickListener, HandleBackTrace {
    ...
    public View onCreateView(LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        View inflate = layoutInflater.inflate(2130968591, viewGroup, false);
        inflate.findViewById(2131558462).setOnClickListener(this);
        adjustViewSize(inflate.findViewById(2131558463));
        return inflate;
    }
