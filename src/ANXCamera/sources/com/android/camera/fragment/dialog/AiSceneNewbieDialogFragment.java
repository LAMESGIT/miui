...
public class AiSceneNewbieDialogFragment extends BaseDialogFragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        View inflate = layoutInflater.inflate(2130968590, viewGroup, false);
        initViewOnTouchListener(inflate);
        adjustViewHeight(inflate.findViewById(2131558461));
        return inflate;
    }
    ...
    private void resumeMode() {
        ...
        if (isAdded()) {
            ...
            if (!camera.isActivityPaused() && !camera.isSwitchingModule()) {
                ...
                FunctionDataSetup functionDataSetup = new FunctionDataSetup(163);
                FunctionUISetup functionUISetup = new FunctionUISetup(163, true);
                try {
