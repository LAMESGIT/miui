...
public class PortraitNewbieDialogFragment extends BaseDialogFragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        if (DataRepository.dataItemFeature().fa()) {
            inflate = layoutInflater.inflate(2130968596, viewGroup, false);
        } else {
            inflate = layoutInflater.inflate(2130968595, viewGroup, false);
        }
        initViewOnTouchListener(inflate);
        adjustViewHeight(inflate.findViewById(2131558471));
        return inflate;
    }
