...
public class ExtraRecyclerViewAdapter extends Adapter<CommonRecyclerViewHolder> implements OnClickListener {
    ...
    public CommonRecyclerViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View inflate = LayoutInflater.from(viewGroup.getContext()).inflate(2130968615, viewGroup, false);
    ...
    public void onBindViewHolder(CommonRecyclerViewHolder commonRecyclerViewHolder, int i) {
        ...
        TextView textView = (TextView) commonRecyclerViewHolder.getView(2131558536);
        ColorImageView colorImageView = (ColorImageView) commonRecyclerViewHolder.getView(2131558535);
        if (componentDataItem.mIconRes != -1) {
            colorImageView.setVisibility(0);
            colorImageView.setImageResource(componentDataItem.mIconRes);
            textView.setTextSize(0, (float) commonRecyclerViewHolder.itemView.getResources().getDimensionPixelSize(2131361796));
        } else {
            colorImageView.setVisibility(8);
            textView.setTextSize(0, (float) commonRecyclerViewHolder.itemView.getResources().getDimensionPixelSize(2131361908));
        }
        if (componentDataItem.mDisplayNameRes != -2) {
            textView.setVisibility(0);
            textView.setText(componentDataItem.mDisplayNameRes);
            colorImageView.setPadding(0, 0, 0, commonRecyclerViewHolder.itemView.getResources().getDimensionPixelSize(2131361941));
        } else {
