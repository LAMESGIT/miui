...
public class FragmentManually extends BaseFragment implements OnClickListener, ManuallyListener, HandleBackTrace, ManuallyAdjust {
    ...
    public void initView(View view) {
        ...
        this.mIndicatorButton = (ImageView) view.findViewById(2131558527);
        this.mIndicatorButton.setOnClickListener(this);
        this.mManuallyParent = (ViewGroup) view.findViewById(2131558528);
        this.mRecyclerViewLayout = (ViewGroup) this.mManuallyParent.findViewById(2131558530);
        this.mRecyclerView = (RecyclerView) this.mRecyclerViewLayout.findViewById(2131558531);
        this.mDecoration = new ManuallyDecoration(1, getResources().getColor(2131427399));
                ...
                if (view.getId() != 2131558527) {
                    ...
                    if (displayTitleString != 2131296663) {
                        ...
                        if (this.mFragmentManuallyExtra == null) {
                            ...
                            FragmentUtils.addFragmentWithTag(getChildFragmentManager(), 2131558529, this.mFragmentManuallyExtra, this.mFragmentManuallyExtra.getFragmentTag());
    ...
    public int visibleHeight() {
        ...
        return this.mManuallyParent.getHeight() + (getResources().getDimensionPixelSize(2131361946) / 2);
    }
    ...
    private void initManually() {
        ...
        this.mRecyclerView.getLayoutParams().height = getResources().getDimensionPixelSize(2131361811);
    ...
    private void initScene(ManuallyListener manuallyListener) {
        ...
        this.mRecyclerView.getLayoutParams().height = getResources().getDimensionPixelSize(2131361812);
    ...
    private void adjustViewBackground(int i) {
        ...
        if (i != 3) {
            switch (i) {
                case 0:
                    this.mRecyclerViewLayout.setBackgroundResource(2131427400);
                    return;
                case 1:
                    break;
                default:
        ...
        this.mRecyclerViewLayout.setBackgroundResource(2131427401);
    }
}
