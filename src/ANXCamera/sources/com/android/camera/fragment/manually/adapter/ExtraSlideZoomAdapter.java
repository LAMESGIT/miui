...
public class ExtraSlideZoomAdapter extends HorizontalDrawAdapter implements OnPositionSelectListener {
    ...
    private void initStyle(Context context) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(2131492879, new int[]{16842901, 16842904});
        ...
        this.mLineHalfHeight = ((float) resources.getDimensionPixelSize(2131361813)) / 2.0f;
        this.mLineWidth = resources.getDimensionPixelSize(2131361814);
        this.mDotRadius = resources.getDimensionPixelSize(2131361817);
        this.mLineLineGap = resources.getDimensionPixelSize(2131361815);
        this.mLineTextGap = resources.getDimensionPixelSize(2131361816);
        this.mLineDotYGap = resources.getDimensionPixelSize(2131361818);
        this.mLineColorDefault = resources.getColor(2131427406);
        this.mDotColorActivated = resources.getColor(2131427407);
        ...
        this.mDigitsTextStyle = new TextAppearanceSpan(context, 2131492886);
        this.mXTextStyle = new TextAppearanceSpan(context, 2131492887);
    }
