...
public class ExtraSlideFNumberAdapter extends HorizontalDrawAdapter implements OnPositionSelectListener {
    ...
    private void initStyle(Context context) {
        ...
        this.mLineHalfHeight = ((float) resources.getDimensionPixelSize(2131362028)) / 2.0f;
        this.mLineWidth = resources.getDimensionPixelSize(2131362030);
        this.mLineLineGap = resources.getDimensionPixelSize(2131362031);
        this.mLineColorDefault = resources.getColor(2131427431);
        this.mLineColorDivider = resources.getColor(2131427432);
        this.mLineColorDefaultCircle = resources.getColor(2131427434);
        this.mLineCircleRadius = resources.getDimensionPixelSize(2131362032);
        this.mLineDefaultCircleGap = resources.getDimensionPixelSize(2131362033);
