...
public class FragmentLiveSticker extends FragmentLiveBase implements OnCtaNoticeClickListener {
    ...
    private static final LiveStickerInfo[] sLocalStickerList = new LiveStickerInfo[]{new LiveStickerInfo("", "", 2130837714), new LiveStickerInfo(CameraStat.PARAM_BEAUTY_BODY_SLIM, "0eb0e0214f7bc7f7bbfb4e9f4dba7f99", "f2e24fea41e33a1c0fc9a79b8d3b91e2.png", "保持全身在画面中哦"), new LiveStickerInfo("星空喵", "a75682e81788cc12f68682b9c9067f70", "8ca064318882fa610f4623b852accd36.png"), new LiveStickerInfo("浮生若梦", "24991e783f23920397ac8aeed15994c2", "e42237f75eeff4e5162f9b0130492e36.png")};
    private static final LiveStickerInfo sMoreSticker = new LiveStickerInfo("", "", 2130837792);
    ...
    private static class StickerItemAdapter extends Adapter<StickerItemHolder> {
        Context mContext;
        f mGlideOptions = new f().J(2130837795);
        ...
        class StickerItemHolder extends CommonRecyclerViewHolder implements OnClickListener, OnDownloadSuccessListener {
            ...
            public StickerItemHolder(View view) {
                ...
                ((LiveDownloadView) getView(2131558520)).setOnDownloadSuccessListener(this);
            }
        ...
        public StickerItemHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            return new StickerItemHolder(this.mLayoutInflater.inflate(2130968611, viewGroup, false));
        }

        public void onBindViewHolder(StickerItemHolder stickerItemHolder, int i) {
            LiveDownloadView liveDownloadView = (LiveDownloadView) stickerItemHolder.getView(2131558520);
            ImageView imageView = (ImageView) stickerItemHolder.getView(2131558518);
            View view = stickerItemHolder.getView(2131558519);
    ...
    public void initView(View view) {
        this.mRootView = view;
        this.mItemWidth = getResources().getDimensionPixelSize(2131362074);
        this.mTotalWidth = getResources().getDisplayMetrics().widthPixels;
        final boolean isLayoutRTL = Util.isLayoutRTL(getContext());
        this.mUpdatingView = this.mRootView.findViewById(2131558517);
        this.mStickerListView = (RecyclerView) this.mRootView.findViewById(2131558516);
        this.mSelectIndex = 0;
        ...
        this.mStickerListView.addItemDecoration(new ItemDecoration() {
            final int mLeftMargin = FragmentLiveSticker.this.getResources().getDimensionPixelSize(2131362072);
            final int mRightMargin = FragmentLiveSticker.this.getResources().getDimensionPixelSize(2131362073);
    ...
    private void showNetworkErrorHint() {
        ToastUtils.showToast(getContext(), getResources().getString(2131296817), 80);
    }
        ...
        new TTLiveStickerResourceRequest(CameraSettings.isLiveStickerInternalChannel() ? "local_test" : MonitorCommonConstants.DEFAULT_AID, MonitorCommonConstants.DEFAULT_AID).execute(CameraSettings.isLiveStickerInternalChannel() ^ 1, new ResponseListener() {
            ...
            public void onResponseError(ErrorCode errorCode, String str, Object obj) {
                ...
                for (int i = 0; i < length; i++) {
                    ...
                    liveStickerInfo.iconId = 2130837795;
