...
public class FragmentLiveSpeed extends FragmentLiveBase {
    ...
    private static class SpeedItemAdapter extends Adapter<SpeedItemHolder> {
        ...
        public SpeedItemAdapter(Context context, List<LiveSpeedItem> list, int i, OnItemClickListener onItemClickListener) {
            ...
            this.mColorNormal = context.getResources().getColor(2131427393);
            this.mColorSelected = context.getResources().getColor(2131427396);
        }

        public SpeedItemHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            return new SpeedItemHolder(this.mLayoutInflater.inflate(2130968609, viewGroup, false));
        }
        ...
        public void onBindViewHolder(SpeedItemHolder speedItemHolder, int i) {
            ...
            TextView textView = (TextView) speedItemHolder.getView(2131558515);
    ...
    public void initView(View view) {
        ...
        this.mSpeedListView = (RecyclerView) this.mRootView.findViewById(2131558514);
        ...
        this.mSpeedListView.addItemDecoration(new ItemDecoration() {
            final int mListMargin = FragmentLiveSpeed.this.getResources().getDimensionPixelSize(2131362084);

            public void getItemOffsets(Rect rect, View view, RecyclerView recyclerView, State state) {
                int itemCount = ((FragmentLiveSpeed.this.getResources().getDisplayMetrics().widthPixels - (2 * this.mListMargin)) - (recyclerView.getAdapter().getItemCount() * FragmentLiveSpeed.this.getResources().getDimensionPixelSize(2131362085))) / (recyclerView.getAdapter().getItemCount() - 1);
