...
public class V6GestureRecognizer {
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        int isGestureDetecting = isGestureDetecting() ^ 1;
    ...
    private boolean checkControlView(MotionEvent motionEvent) {
        ...
        if (mainContentProtocol != null) {
            if (mainContentProtocol.isAutoZoomViewEnabled()) {
                mainContentProtocol.onViewTouchEvent(2131558636, motionEvent);
            } else {
                if (mainContentProtocol.isEffectViewVisible()) {
                    mainContentProtocol.onViewTouchEvent(2131558641, motionEvent);
                ...
                if (mainContentProtocol.isIndicatorVisible(2)) {
                    ...
                    mainContentProtocol.onViewTouchEvent(2131558635, motionEvent);
