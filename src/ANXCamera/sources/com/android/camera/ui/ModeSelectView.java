...
public class ModeSelectView extends LinearLayout implements OnClickListener {
    ...
    public void init(ComponentModuleList componentModuleList, int i) {
        ...
        while (true) {
            ...
            ViewGroup viewGroup = (ViewGroup) LayoutInflater.from(getContext()).inflate(2130968617, this, false);
            ColorActivateTextView colorActivateTextView = (ColorActivateTextView) viewGroup.findViewById(2131558414);
            ...
            if (intValue == 174 && componentModuleList.needShowLiveRedDot()) {
                viewGroup.findViewById(2131558540).setVisibility(0);
            }
    ...
    private void setSelection(int i, List<Completable> list) {
        ...
        View findViewById = viewGroup.findViewById(2131558540);
        ...
        if (Util.isAccessible()) {
            ...
            stringBuilder.append(getContext().getString(2131296494));
    ...
    public void onClick(View view) {
        if (isEnabled() && this.mOnModeClickedListener != null) {
            ...
            view = view.findViewById(2131558540);
        ...
        if (this.mLastActivateTextView != null && ((Integer) ((ViewGroup) this.mLastActivateTextView.getParent()).getTag()).intValue() != i) {
            ...
            for (int i2 = 0; i2 < getChildCount(); i2++) {
                if (i == ((Integer) getChildAt(i2).getTag()).intValue()) {
                    ...
                    ColorActivateTextView colorActivateTextView = (ColorActivateTextView) ((ViewGroup) getChildAt(i2)).findViewById(2131558414);
                    if (Util.isAccessible()) {
