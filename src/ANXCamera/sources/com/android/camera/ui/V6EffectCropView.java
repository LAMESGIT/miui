...
public class V6EffectCropView extends View implements V6FunctionUI {
    ...
    public V6EffectCropView(Context context, AttributeSet attributeSet) {
        ...
        this.mTiltShiftMaskFadeInAnimator = (ObjectAnimator) AnimatorInflater.loadAnimator(context, 2131034118);
        this.mTiltShiftMaskFadeOutAnimator = (ObjectAnimator) AnimatorInflater.loadAnimator(context, 2131034119);
    ...
    private void innerShow() {
        int i = 1;
        boolean isTiltShift = isTiltShift() ^ 1;
