...
public class V9EdgeShutterView extends View implements V6FunctionUI {
    private static final int CENTER_RADIUS = CameraAppImpl.getAndroidContext().getResources().getDimensionPixelSize(2131361875);
    ...
    private static final int OUT_RADIUS = CameraAppImpl.getAndroidContext().getResources().getDimensionPixelSize(2131361874);
    ...
    private static final int VIEW_WIDTH = CameraAppImpl.getAndroidContext().getResources().getDimensionPixelSize(2131361876);
    ...
    public boolean onEdgeTouch(int i, int i2) {
        ...
        if (this.mMessageDispatcher != null) {
            this.mMessageDispatcher.dispatchMessage(0, 2131558658, 2, null, null);
        }
    ...
    private ValueAnimator createFlyInAnimation() {
        ...
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(this, "translationX", new float[]{(float) i, (float) null});
    ...
    private ValueAnimator createFlyOutAnimation() {
        ...
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(this, "translationX", new float[]{(float) null, (float) i});
