...
public class CameraFocusPaintEvText extends CameraPaintBase {
    ...
    public CameraFocusPaintEvText(Context context) {
        super(context);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(2131492872, new int[]{16842901, 16842904});
        ...
        this.mEvTextMargin = context.getResources().getDimensionPixelSize(2131361855);
    }
