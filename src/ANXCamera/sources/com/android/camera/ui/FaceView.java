...
public class FaceView extends FrameView {
    ...
    public FaceView(Context context, AttributeSet attributeSet) {
        ...
        this.mEffectRectPaint.setStrokeWidth((float) getResources().getDimensionPixelSize(2131361871));
    ...
    private void initFaceInfoStyle() {
        if (this.mFaceInfoTextPaint == null) {
            ...
            this.mFaceAgeFormat = resources.getString(2131296584);
            this.mFaceScoreInfoFormat = resources.getString(2131296585);
            this.mMaleAgeInfoPop = resources.getDrawable(2130837918);
            this.mFemaleAgeInfoPop = resources.getDrawable(2130837571);
            this.mSexMaleIc = resources.getDrawable(2130837852);
            this.mSexFemaleIc = resources.getDrawable(2130837851);
            this.mFaceInfoTextPaint = new Paint();
            this.mFaceInfoTextPaint.setAntiAlias(true);
            this.mFaceInfoTextPaint.setColor(-1);
            float dimension = resources.getDimension(2131361862);
            ...
            this.mMagicMirrorInfoPop = resources.getDrawable(2130837916);
            this.mBeautyScoreIc = resources.getDrawable(2130837697);
            this.mAgeVerPadding = resources.getDimensionPixelSize(2131361865);
            this.mGap = resources.getDimensionPixelSize(2131361867);
            this.mCorrection = resources.getDimensionPixelOffset(2131361868);
            this.mPopBottomMargin = resources.getDimensionPixelSize(2131361866);
            this.mScoreHonPadding = resources.getDimensionPixelSize(2131361869);
            this.mScoreVerPadding = resources.getDimensionPixelSize(2131361870);
            this.mAgeMaleHonPadding = resources.getDimensionPixelSize(2131361863);
            this.mAgeFemaleHonPadding = resources.getDimensionPixelSize(2131361864);
    ...
    private void setContentDescription(int i) {
        if (i > 0) {
            announceForAccessibility(getResources().getQuantityString(2131820544, i, new Object[]{Integer.valueOf(i)}));
        }
    }
