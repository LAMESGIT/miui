...
public class SeekBarCompat extends SeekBar implements OnTouchListener, OnSeekBarChangeListener {
    ...
    public synchronized void onDraw(Canvas canvas) {
        if (this.mCenterMode) {
            ...
            canvas.drawCircle((float) (getWidth() / 2), (float) (getHeight() / 2), (float) getResources().getDimensionPixelSize(2131362006), this.mCenterPointPain);
    ...
    public void setCenterSeekbarMode(boolean z) {
        this.mCenterMode = z;
        if (this.mCenterMode) {
            this.mCenterProgressBgDrawable = getResources().getDrawable(2130837540);
