...
public class PanoMovingIndicatorView extends View {
    ...
    private int mArrowMargin = CameraAppImpl.getAndroidContext().getResources().getDimensionPixelOffset(2131361807);
    ...
    public PanoMovingIndicatorView(Context context, AttributeSet attributeSet) {
        ...
        this.mMovingDirectionIc.setWidth(context.getResources().getDimensionPixelSize(2131361808));
        this.mMovingDirectionIc.setHeight(context.getResources().getDimensionPixelSize(2131361809));
        this.mTailPaint = new Paint();
        this.mTailPaint.setColor(-1);
        this.mHalfStoneHeight = context.getResources().getDimensionPixelSize(2131361810);
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.mCurrentFramePos.x != Integer.MIN_VALUE && this.mCurrentFramePos.y != Integer.MIN_VALUE) {
            ...
            i = -triangleIndicatorDrawable.getIntrinsicWidth();
            triangleIndicatorDrawable.setBounds(i, (-triangleIndicatorDrawable.getIntrinsicHeight()) / 2, 0, triangleIndicatorDrawable.getIntrinsicHeight() / 2);
            triangleIndicatorDrawable.draw(canvas2);
            canvas2.translate((float) triangleIndicatorDrawable.getIntrinsicWidth(), PanoramaArrowAnimateDrawable.LEFT_ARROW_RATIO);
            ...
            canvas2.drawRect((float) i5, (float) (-this.mHalfStoneHeight), (float) (-triangleIndicatorDrawable.getIntrinsicWidth()), (float) this.mHalfStoneHeight, this.mTailPaint);
            if (1 == this.mDirection) {
                canvas2.rotate(-180.0f);
            }
            canvas2.translate((float) (-i3), (float) (-i4));
