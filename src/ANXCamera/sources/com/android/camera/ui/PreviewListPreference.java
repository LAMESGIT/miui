...
public class PreviewListPreference extends ListPreference {
    ...
    public PreviewListPreference(Context context, AttributeSet attributeSet) {
        ...
        this.mExtraPaddingEnd = context.getResources().getDimensionPixelSize(2131361936);
    ...
    private CharSequence findSupportedDefaultValue(CharSequence[] charSequenceArr) {
        ...
        for (Object obj : entryValues) {
            for (Object obj2 : charSequenceArr) {
    ...
    public void onBindView(View view) {
        ...
        TextView textView = (TextView) view.findViewById(2131558611);
        ImageView imageView = (ImageView) view.findViewById(2131558612);
        if (textView != null) {
    ...
    public View onCreateView(ViewGroup viewGroup) {
        return LayoutInflater.from(getContext()).inflate(2130968639, viewGroup, false);
    }
