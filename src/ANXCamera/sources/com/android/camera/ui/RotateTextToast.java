...
public class RotateTextToast {
    ...
    public void show(int i, int i2) {
        ...
        ((TextView) this.mToast.findViewById(2131558601)).setText(i);
    ...
    private RotateTextToast(Activity activity) {
        ...
        this.mToast = (RotateLayout) activity.getLayoutInflater().inflate(2130968641, this.mLayoutRoot).findViewById(2131558622);
    }
}
