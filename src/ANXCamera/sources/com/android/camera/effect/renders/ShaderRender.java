...
public abstract class ShaderRender extends Render {
    ...
    protected float[] mPreviewEffectRect = new float[]{PanoramaArrowAnimateDrawable.LEFT_ARROW_RATIO, PanoramaArrowAnimateDrawable.LEFT_ARROW_RATIO, 1.0f, 1.0f};
    protected int mProgram = 0;
    protected float[] mSnapshotEffectRect = new float[]{PanoramaArrowAnimateDrawable.LEFT_ARROW_RATIO, PanoramaArrowAnimateDrawable.LEFT_ARROW_RATIO, 1.0f, 1.0f};
