    ...
    public boolean draw(DrawAttribute drawAttribute) {
        ...
        if (renders != null) {
            ...
            while (id < size) {
                ...
                List list;
                Object obj;
                DrawIntTexAttribute drawIntTexAttribute3;
                int i10;
                int i11;
                ...
                if (id != 0) {
                    ...
                    if (obj2 == null) {
                        drawIntTexAttribute2.mX = i;
                        drawIntTexAttribute2.mY = i2;
                        drawIntTexAttribute2.mWidth = i3;
                        drawIntTexAttribute2.mHeight = i4;
                    }
                    ...
                    i12 = i7;
                    i13 = i6;
                    drawIntTexAttribute3 = new DrawIntTexAttribute(i5, 0, 0, i6, i12, z);
                    render.draw(drawIntTexAttribute3);
                    i7 = i12;
                }
                if (obj2 != null) {
                    i10 = i7;
                    i11 = i6;
                    drawIntTexAttribute3 = new DrawIntTexAttribute(this.mFrameBufferTextures[i9], 0, 0, i6, i10, z);
                    endBindFrameBuffer();
                } else {
                    i10 = i7;
                    i11 = i6;
