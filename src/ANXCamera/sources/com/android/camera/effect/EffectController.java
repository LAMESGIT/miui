...
public class EffectController {
        ...
        synchronized (this) {
            ...
            if (!(isDualCameraWaterMarkOpen || isTimeWaterMarkOpen || isAgeGenderWaterMarkOpen)) {
                if (!isMagicMirrorWaterMarkOpen) {
                    ...
                    fg = fg && isDualCameraWaterMarkOpen;
                    if (gi && (z2 || isSquareModule || isGradienterOn || isTiltShiftOn || fg)) {
                        z = true;
                    }
                }
            }
            isDualCameraWaterMarkOpen = true;
            if (!fg) {
            }
            z = true;
        }
    ...
    private ArrayList<FilterInfo> initNormalFilterInfoNew() {
        ArrayList arrayList = new ArrayList();
        arrayList.add(new FilterInfo(FilterInfo.FILTER_ID_NONE, 2131296361, 2130837550, 0));
    ...
    private ArrayList<FilterInfo> initStickerFilterInfo() {
        ArrayList arrayList = new ArrayList();
        arrayList.add(new FilterInfo(FilterInfo.FILTER_ID_NONE, 2131296361, 2130837980, 0));
    ...
    private RenderGroup getPrivateRender(GLCanvas gLCanvas, RenderGroup renderGroup, boolean z, boolean z2, int i) {
        ...
        if (renderGroup2.getRender(FilterInfo.FILTER_ID_BLUR) == null && (z || i3 == FilterInfo.FILTER_ID_BLUR || i3 < 0)) {
            if (z || i3 == FilterInfo.FILTER_ID_BLUR || renderGroup2.isPartComplete(2)) {
                int i5 = (renderGroup2.getPartRender(0) == null || !(renderGroup2.getPartRender(0) instanceof XBlurEffectRender)) ? 0 : 1;
                int i6 = (renderGroup2.getPartRender(1) == null || !(renderGroup2.getPartRender(1) instanceof YBlurEffectRender)) ? 0 : 1;
        ...
        if (renderGroup2.getRender(FilterInfo.FILTER_ID_TILTSHIFT) == null && b.hl() && (z || i3 == FilterInfo.FILTER_ID_TILTSHIFT || (i3 < 0 && r0 == 0))) {
        ...
        if (d.getBoolean(d.th, false) || renderGroup2.getRender(FilterInfo.FILTER_ID_GAUSSIAN) != null || (!z && i3 != FilterInfo.FILTER_ID_GAUSSIAN && (i3 >= 0 || i2 != 0))) {
            i4 = i2;
        ...
        if (renderGroup2.getRender(FilterInfo.FILTER_ID_PEAKINGMF) == null && b.ha() && !z2 && (z || i3 == FilterInfo.FILTER_ID_PEAKINGMF || (i3 < 0 && i4 == 0))) {
    ...
    public List<LiveFilterItem> getLiveFilterList(Context context) {
        if (this.mLiveFilters == null) {
            TypedArray obtainTypedArray = context.getResources().obtainTypedArray(2131623979);
            String[] stringArray = context.getResources().getStringArray(2131623980);
            String[] stringArray2 = context.getResources().getStringArray(2131623981);
