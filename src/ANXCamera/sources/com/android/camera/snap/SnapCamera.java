...
public class SnapCamera implements OnErrorListener, OnInfoListener {
    ...
    private void initCamera() {
        ...
        try {
            ...
            str = TAG;
            stringBuilder = new StringBuilder();
            stringBuilder.append("initCamera: ");
            stringBuilder.append(e.getMessage());
    ...
    private void initOrientationListener() {
        this.mOrientationListener = new OrientationEventListener(this.mContext, b.id() ? 2 : 3) {
    ...
    public synchronized void takeSnap() {
        ...
        r4 = this;
        monitor-enter(r4);
        r0 = r4.mCameraDevice;	 Catch:{ all -> 0x0052 }
        if (r0 != 0) goto L_0x000e;
    L_0x0005:
        r0 = TAG;	 Catch:{ all -> 0x0052 }
        r1 = "takeSnap: CameraDevice is opening or was already closed.";
        com.android.camera.log.Log.e(r0, r1);	 Catch:{ all -> 0x0052 }
        monitor-exit(r4);
        return;
    L_0x000e:
        r0 = r4.mCaptureSession;	 Catch:{ all -> 0x0052 }
        if (r0 != 0) goto L_0x004d;
    L_0x0012:
        r0 = 2;
        r0 = new android.view.Surface[r0];	 Catch:{ all -> 0x0052 }
        r1 = 0;
        r2 = r4.mPreviewSurface;	 Catch:{ all -> 0x0052 }
        r0[r1] = r2;	 Catch:{ all -> 0x0052 }
        r1 = 1;
        r2 = r4.mPhotoImageReader;	 Catch:{ all -> 0x0052 }
        r2 = r2.getSurface();	 Catch:{ all -> 0x0052 }
        r0[r1] = r2;	 Catch:{ all -> 0x0052 }
        r0 = java.util.Arrays.asList(r0);	 Catch:{ all -> 0x0052 }
        r1 = r4.mCameraDevice;	 Catch:{ CameraAccessException -> 0x0031 }
        r2 = r4.mSessionCallback;	 Catch:{ CameraAccessException -> 0x0031 }
        r3 = r4.mCameraHandler;	 Catch:{ CameraAccessException -> 0x0031 }
        r1.createCaptureSession(r0, r2, r3);	 Catch:{ CameraAccessException -> 0x0031 }
        goto L_0x004c;
    L_0x0031:
        r0 = move-exception;
        ...
        r3 = r0.getMessage();	 Catch:{ all -> 0x0052 }
        r2.append(r3);	 Catch:{ all -> 0x0052 }
        r2 = r2.toString();	 Catch:{ all -> 0x0052 }
        com.android.camera.log.Log.e(r1, r2, r0);	 Catch:{ all -> 0x0052 }
    L_0x004c:
        goto L_0x0050;
    L_0x004d:
        r4.capture();	 Catch:{ all -> 0x0052 }
    L_0x0050:
        monitor-exit(r4);
        return;
    L_0x0052:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.camera.snap.SnapCamera.takeSnap():void");
    }
    ...
    private void setupMediaRecorder() {
        ...
        String format = new SimpleDateFormat(this.mContext.getString(2131296457), Locale.ENGLISH).format(Long.valueOf(currentTimeMillis));
        StringBuilder stringBuilder = new StringBuilder();
