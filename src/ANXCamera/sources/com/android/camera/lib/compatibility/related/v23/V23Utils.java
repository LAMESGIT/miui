...
public class V23Utils {
    ...
    public static String getSdcardPath(Context context) {
        ...
        if (VERSION.SDK_INT >= 23) {
            List<Object> volumes = ((StorageManager) context.getSystemService("storage")).getVolumes();
            if (volumes != null) {
                for (Object obj : volumes) {
                    if (obj.getType() == 0 && obj.isMountedWritable()) {
                        DiskInfo disk = obj.getDisk();
                        String str2 = TAG;
