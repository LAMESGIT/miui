...
public class Camera extends ActivityBase implements OnRequestPermissionsResultCallback, BaseLifecycleListener, BaseProtocol {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (CompatibilityUtils.isInMultiWindowMode(this)) {
            super.onCreate(null);
            ToastUtils.showToast((Context) this, 2131296755);
            ...
            this.mGLView = (V6CameraGLSurfaceView) findViewById(2131558627);
            this.mGLCoverView = (ImageView) findViewById(2131558628);
            this.mDebugInfoView = (TextView) findViewById(2131558646);
            this.mEdgeShutterView = (V9EdgeShutterView) findViewById(2131558658);
            this.mCameraRootView = (CameraRootView) findViewById(2131558645);
    ...
    public void onStop() {
        ...
        super.onStop();
        if (this.mDelayReleaseCamera) {
            if (isGotoGallery() || isSelectingCapturedResult()) {
                this.mDelayReleaseCamera = false;
    ...
    private boolean closeCameraSetup() {
        /*
        r3 = this;
        r0 = r3.mCameraPendingSetupDisposableGuard;
        monitor-enter(r0);
        r1 = r3.mCameraPendingSetupDisposable;	 Catch:{ all -> 0x0037 }
        r2 = 0;
        if (r1 == 0) goto L_0x0017;
    L_0x0008:
        r1 = r3.mCameraPendingSetupDisposable;	 Catch:{ all -> 0x0037 }
        r1 = r1.isDisposed();	 Catch:{ all -> 0x0037 }
        if (r1 != 0) goto L_0x0017;
    L_0x0010:
        r1 = r3.mCameraPendingSetupDisposable;	 Catch:{ all -> 0x0037 }
        r1.dispose();	 Catch:{ all -> 0x0037 }
        r3.mCameraPendingSetupDisposable = r2;	 Catch:{ all -> 0x0037 }
    L_0x0017:
        monitor-exit(r0);	 Catch:{ all -> 0x0037 }
        r1 = r3.mCameraSetupDisposableGuard;
        monitor-enter(r1);
        r0 = r3.mCameraSetupDisposable;	 Catch:{ all -> 0x0034 }
        if (r0 == 0) goto L_0x0031;
    L_0x001f:
        r0 = r3.mCameraSetupDisposable;	 Catch:{ all -> 0x0034 }
        r0 = r0.isDisposed();	 Catch:{ all -> 0x0034 }
        if (r0 != 0) goto L_0x0031;
    L_0x0027:
        r0 = r3.mCameraSetupDisposable;	 Catch:{ all -> 0x0034 }
        r0.dispose();	 Catch:{ all -> 0x0034 }
        r3.mCameraSetupDisposable = r2;	 Catch:{ all -> 0x0034 }
        r0 = 1;
    ...
    L_0x0037:
        ...
        throw r1;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.camera.Camera.closeCameraSetup():boolean");
    }
    ...
    public boolean showNewBie(int i) {
        switch (i) {
            case 1:
                ...
                portraitNewbieDialogFragment.setStyle(2, 2131492894);
            ...
            case 2:
                ...
                frontRotateNewbieDialogFragment.setStyle(2, 2131492894);
                ...
                this.mHandler.postDelayed(new Runnable() {
                    public void run() {
                        if (!Camera.this.isActivityPaused()) {
                            ...
                            aiSceneNewbieDialogFragment.setStyle(2, 2131492894);
                ...
                this.mHandler.postDelayed(new Runnable() {
                    public void run() {
                        if (!Camera.this.isActivityPaused()) {
                            ...
                            ultraWideNewbieDialogFragment.setStyle(2, 2131492894);
    ...
    public void notifyOnFirstFrameArrived(int i) {
        if (this.mCurrentModule != null && !this.mCurrentModule.isDeparted() && !isSwitchingModule()) {
            ...
            if ((getCurrentModuleIndex() == 165 || getCurrentModuleIndex() == 163) && b.hI() && CameraSettings.isFrontCamera() && this.mDisplayRotation == 0 && DataRepository.dataItemGlobal().getBoolean("pref_front_camera_first_use_hint_shown_key", true)) {
    ...
    private void showHibernationFragment() {
        ...
        hibernationFragment.setStyle(2, 2131492894);
    ...
    public void showLensDirtyDetectedHint() {
        if (DataRepository.dataItemFeature().fK()) {
            ...
            lensDirtyDetectDialogFragment.setStyle(2, 2131492895);
    ...
    public boolean handleScreenSlideKeyEvent(int i, KeyEvent keyEvent) {
        ...
        if (i == Util.KEYCODE_SLIDE_OFF && getCameraIntentManager().isFromScreenSlide().booleanValue() && !isModeSwitched()) {
            finish();
            overridePendingTransition(2131034114, 2131034115);
            return true;
        }
        DataItemGlobal dataItemGlobal = DataRepository.dataItemGlobal();
        ...
        if ((currentMode == 171 && !b.hz()) || currentMode == 166 || currentMode == 167 || currentMode == 173) {
            currentMode = 163;
