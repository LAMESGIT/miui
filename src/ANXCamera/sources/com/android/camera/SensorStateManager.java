...
public class SensorStateManager {
     ...
     */
        public void onSensorChanged(android.hardware.SensorEvent r5) {
            /*
            r4 = this;
            r0 = com.android.camera.SensorStateManager.this;
            r0 = r0.getSensorStateListener();
        ...
        L_0x003d:
            return;
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.camera.SensorStateManager$AnonymousClass4.onSensorChanged(android.hardware.SensorEvent):void");
        }
    ...
    public void setRotationIndicatorEnabled(boolean z) {
        if (b.hA() && canDetectOrientation() && this.mRotationFlagEnabled != z) {
