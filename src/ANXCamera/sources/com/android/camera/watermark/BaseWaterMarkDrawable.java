...
public abstract class BaseWaterMarkDrawable {
    ...
    public BaseWaterMarkDrawable(List<WaterMarkData> list) {
        ...
        this.mFaceInfoTextPaint.setTextSize(CameraAppImpl.getAndroidContext().getResources().getDimension(2131361862));
        this.mFaceInfoTextPaint.setTextAlign(Align.CENTER);
        this.mFaceInfoTextPaint.setFakeBoldText(true);
        this.mGap = CameraAppImpl.getAndroidContext().getResources().getDimensionPixelSize(2131361867);
        this.mCorrection = CameraAppImpl.getAndroidContext().getResources().getDimensionPixelOffset(2131361868);
        ...
        this.mGap = this.mContext.getResources().getDimensionPixelSize(2131361867);
        this.mCorrection = this.mContext.getResources().getDimensionPixelOffset(2131361868);
        this.mPopBottomMargin = this.mContext.getResources().getDimensionPixelSize(2131361866);
        initBeforeDraw();
        draw();
    }
