...
public class CameraSettings {
    ...
    public static final String KEY_AUTO_ZOOM_ULTRA_COUNT = "pref_auto_zoom_ultra_count";
    ...
    public static final int SURFACE_LEFT_MARGIN_MDP_QUALITY_480P = CameraAppImpl.getAndroidContext().getResources().getDimensionPixelSize(2131361872);
    public static final int SURFACE_LEFT_MARGIN_MDP_QUALITY_LOW = CameraAppImpl.getAndroidContext().getResources().getDimensionPixelSize(2131361873);
    private static final String TAG = "CameraSettings";
    public static final int TOP_CONTROL_HEIGHT = CameraAppImpl.getAndroidContext().getResources().getDimensionPixelSize(2131361822);
    ...
    public static final int[] sLiveSpeedTextList = new int[]{2131296811, 2131296812, 2131296813, 2131296814, 2131296815};
    ...
    public static String getHfrSetting() {
        return DataRepository.dataItemConfig().getString(KEY_VIDEO_HIGH_FRAME_RATE, getString(2131296308));
    }
    ...
    public static int getSkipFrameNumber() {
        if (isFrontCamera()) {
            return CameraAppImpl.getAndroidContext().getResources().getInteger(2131755014);
        }
        return 0;
    }

    public static int getPreferVideoQuality(int i) {
        String string = getString(getDefaultPreferenceId(2131296288));
        ...
        if (DataRepository.dataItemConfig().contains(KEY_VIDEO_QUALITY)) {
            ...
            editor2.apply();
            if (string.equals(substring) || Util.isStringValueContained((Object) substring, 2131623939)) {
                string = substring;
            } else {
                String str2 = TAG;
    ...
    public static int getVideoEncoder() {
        if ("h265".equals(DataRepository.dataItemGlobal().getString(KEY_VIDEO_ENCODER, getString(2131296307)))) {
            return 5;
        }
        return 2;
    }
                ...
                default:
                    switch (activeModuleIndex) {
                        ...
                        case 170:
                            break;
                        default:
                            string = DataRepository.dataItemGlobal().getString(KEY_AUTOEXPOSURE, getString(2131296523));
                            break;
                    }
            }
        }
        string = DataRepository.dataItemGlobal().getString(KEY_VIDEO_AUTOEXPOSURE, getString(2131296524));
    ...
    public static int get4kProfile() {
        if (b.gF()) {
            return Integer.parseInt(getString(2131296291));
        }
        return -1;
    }
    ...
    public static ArrayList<String> getSupportedVideoQuality(int i) {
        ...
        int i2 = get4kProfile();
        if (b.gF() && supportedOutputSize.contains(new CameraSize(3840, 2160)) && CamcorderProfile.hasProfile(bogusCameraId, i2)) {
            arrayList.add(Integer.toString(i2));
            if (isSupportFpsRange(3840, 2160, i)) {
                arrayList.add(getString(2131296292));
            }
        }
        if (supportedOutputSize.contains(new CameraSize(1920, 1080)) && CamcorderProfile.hasProfile(bogusCameraId, 6)) {
            ...
            if (isSupportFpsRange(1920, 1080, i)) {
                arrayList.add(getString(2131296293));
            }
        }
    ...
    public static boolean isVideoCaptureVisible() {
        return ((b.isMTKPlatform() && isStereoModeOn()) || isVideoBokehOn() || ((!b.hw() && (VIDEO_SPEED_SLOW.equals(DataRepository.dataItemRunning().getVideoSpeed()) || VIDEO_SPEED_HFR.equals(DataRepository.dataItemRunning().getVideoSpeed()))) || (b.gF() && ((b.qf || b.qh) && getVideoQuality() > 6)))) ? false : true;
    }

    public static int getDefaultPreferenceId(int i) {
        if (i != 2131296288) {
            if (i != 2131296443) {
                if (i == 2131689475 && (b.qh || b.qi)) {
                    return 2131689476;
                }
            } else if (Util.isAntibanding60()) {
                return 2131296446;
            }
        } else if (b.gR() && isFrontCamera()) {
            return 2131296289;
        }
        return i;
    }
    ...
    public static boolean isRecordLocation() {
        if (b.go() && DataRepository.dataItemGlobal().getBoolean(KEY_RECORD_LOCATION, false)) {
            return true;
        }
        return false;
    }
    ...
    public static boolean isCameraSoundOpen() {
        if (!b.gj() || DataRepository.dataItemGlobal().getBoolean(KEY_CAMERA_SOUND, true)) {
            return true;
        }
        return false;
    }
    ...
    public static boolean isDualCameraWaterMarkOpen() {
        if (isSupportedDualCameraWaterMark() && isBackCamera()) {
            return DataRepository.dataItemGlobal().getBoolean("pref_dualcamera_watermark", getBool(2131689491));
        }
        return false;
    }
    ...
    public static boolean isFrontMirror() {
        DataItemGlobal dataItemGlobal = DataRepository.dataItemGlobal();
        String string = dataItemGlobal.getString(KEY_FRONT_MIRROR, getString(2131296614));
        if ("auto".equals(string)) {
            dataItemGlobal.editor().remove(KEY_FRONT_MIRROR).apply();
        }
        return getString(2131296615).equals(string);
    }

    public static boolean isMovieSolidOn() {
        return b.gf() && DataRepository.dataItemGlobal().getBoolean(KEY_MOVIE_SOLID, Boolean.valueOf(getString(2131296549)).booleanValue());
    }
    ...
    public static boolean isScanQRCode(Context context) {
        return !isFrontCamera() && isQRCodeReceiverAvailable(context) && b.hg() && DataRepository.dataItemGlobal().getBoolean(KEY_SCAN_QRCODE, Boolean.valueOf(getString(2131296564)).booleanValue());
    }
    ...
    public static boolean checkLensAvailability(Context context) {
        ...
        if (Util.isGlobalVersion()) {
            if (DataRepository.dataItemGlobal().getBoolean(KEY_AI_DETECT_ENABLE, Boolean.valueOf(getString(2131689490)).booleanValue()) && Util.isPackageAvailable(context, "com.google.ar.lens") && sGoolgeLensAvilability) {
                z = true;
            }
            return z;
        }
    ...
    public static boolean isBurstShootingEnable() {
        return b.gl() && "burst".equals(DataRepository.dataItemGlobal().getString(KEY_LONG_PRESS_SHUTTER_FEATURE, getString(2131296623)));
    }
    ...
    public static boolean isAEAFLockSupport() {
        ...
        return DataRepository.dataItemGlobal().getBoolean(KEY_AE_AF_LOCK_SUPPORT, CameraAppImpl.getAndroidContext().getResources().getBoolean(2131689474));
    }
    ...
    public static String getColorEffect() {
        return DataRepository.dataItemConfig().getString(KEY_COLOR_EFFECT, getString(2131296359));
    }
    ...
    public static int getCustomWB() {
        return DataRepository.dataItemConfig().getInt("pref_qc_manual_whitebalance_k_value_key", CameraAppImpl.getAndroidContext().getResources().getInteger(2131755018));
    }
    ...
    public static String getFocusMode() {
        ...
        if (ModuleManager.isVideoModule() || ModuleManager.isFunModule()) {
            return getString(2131296349);
        }
        return getString(2131296350);
    }
    ...
    public static String getWhiteBalance() {
        return DataRepository.dataItemConfig().getString(KEY_WHITE_BALANCE, getString(2131296356));
    }
    ...
    public static String getManualFocusName(Context context, int i) {
        if (i == 1000) {
            return context.getString(2131296340);
        }
        double d = (double) i;
        if (d >= 600.0d) {
            return context.getString(2131296343);
        }
        if (d >= 200.0d) {
            return context.getString(2131296341);
        }
        return context.getString(2131296342);
    }
    ...
    public static String getSkinBeautifyHumanReadableValue(Context context, ListPreference listPreference) {
        ...
        if (findIndexOfValue > (length * 2) / 3) {
            return context.getString(2131296680);
        }
        if (findIndexOfValue > length / 3) {
            return context.getString(2131296679);
        }
        if (findIndexOfValue > 0) {
            return context.getString(2131296678);
        }
        return context.getString(2131296681);
    }

    public static boolean isFaceBeautyOn(String str) {
        boolean z = true;
        if (DataRepository.dataItemGlobal().getCurrentCameraId() != 0) {
            return BeautyConstant.LEVEL_CLOSE.equals(str) ^ 1;
        }
    ...
    public static String getFaceBeautySwitch() {
        ...
        if (b.hM() || !KEY_FACE_BEAUTY_ADVANCED.equals(string)) {
            return string;
        }
    ...
    public static String getFaceBeautifyValue() {
        ...
        if (b.hM() && KEY_FACE_BEAUTY_ADVANCED.equals(getFaceBeautySwitch())) {
    ...
    public static boolean getPriorityStoragePreference() {
        return DataRepository.dataItemGlobal().getBoolean(KEY_PRIORITY_STORAGE, Boolean.valueOf(getString(2131689472)).booleanValue());
    }
    ...
    public static boolean isPressDownCapture() {
        ...
        if (isFrontCamera() || !"focus".equals(DataRepository.dataItemGlobal().getString(KEY_LONG_PRESS_SHUTTER_FEATURE, getString(2131296623)))) {
            z = true;
        }
        return z;
    }
    ...
    public static boolean isAsdNightEnable() {
        return b.gO() && DataRepository.dataItemGlobal().getBoolean(KEY_CAMERA_ASD_NIGHT, Boolean.valueOf(getString(2131689477)).booleanValue());
    }

    public static boolean isAsdMotionEnable() {
        return b.gM() && DataRepository.dataItemGlobal().getBoolean(KEY_CAMERA_ASD_NIGHT, Boolean.valueOf(getString(2131689477)).booleanValue());
    }
    ...
    public static String getJpegQuality(boolean z) {
        String string = DataRepository.dataItemConfig().getString(KEY_JPEG_QUALITY, getString(2131296334));
    ...
    public static String getMiuiSettingsKeyForStreetSnap(String str) {
        if (str.equals(getString(2131296650))) {
            return "Street-snap-picture";
        }
        if (str.equals(getString(2131296651))) {
    ...
    public static boolean isCameraPortraitWithFaceBeauty() {
        return DataRepository.dataItemGlobal().getBoolean(KEY_CAMERA_PORTRAIT_WITH_FACEBEAUTY, CameraAppImpl.getAndroidContext().getResources().getBoolean(2131689480));
    }

    public static boolean isCameraFaceDetectionAutoHidden() {
        return DataRepository.dataItemGlobal().getBoolean(KEY_CAMERA_FACE_DETECTION_AUTO_HIDDEN, CameraAppImpl.getAndroidContext().getResources().getBoolean(2131689479));
    }

    public static boolean isDualCameraEnable() {
        return DataRepository.dataItemGlobal().getBoolean(KEY_CAMERA_DUAL_ENABLE, CameraAppImpl.getAndroidContext().getResources().getBoolean(2131689481));
    }

    public static boolean isDualCameraSatEnable() {
        return DataRepository.dataItemGlobal().getBoolean(KEY_CAMERA_DUAL_SAT_ENABLE, CameraAppImpl.getAndroidContext().getResources().getBoolean(2131689482));
    }

    public static boolean isMfnrSatEnable() {
        return DataRepository.dataItemGlobal().getBoolean(KEY_CAMERA_MFNR_SAT_ENABLE, CameraAppImpl.getAndroidContext().getResources().getBoolean(2131689486));
    }

    public static boolean isOptimizedFlashEnable() {
        return DataRepository.dataItemGlobal().getBoolean(KEY_CAMERA_OPTIMIZED_FLASH_ENABLE, CameraAppImpl.getAndroidContext().getResources().getBoolean(2131689487));
    }

    public static boolean isSREnable() {
        return b.isSupportSuperResolution() && DataRepository.dataItemGlobal().getBoolean(KEY_CAMERA_SR_ENABLE, CameraAppImpl.getAndroidContext().getResources().getBoolean(2131689488));
    }

    public static boolean isCameraParallelProcessEnable() {
        return isSupportParallelProcess() && DataRepository.dataItemGlobal().getBoolean(KEY_CAMERA_PARALLEL_PROCESS_ENABLE, CameraAppImpl.getAndroidContext().getResources().getBoolean(2131689485));
    }
    ...
    public static boolean isSupportedMetadata() {
        return b.gI() || isSupportedPortrait();
    }
    ...
    public static String getSaturation() {
        String string = getString(2131296408);
        String string2 = DataRepository.dataItemGlobal().getString(KEY_QC_SATURATION, string);
        if (string.equals(string2) || Util.isStringValueContained((Object) string2, 2131623959)) {
            return string2;
        }
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
    ...
    public static String getContrast() {
        String string = getString(2131296406);
        String string2 = DataRepository.dataItemGlobal().getString(KEY_QC_CONTRAST, string);
        if (string.equals(string2) || Util.isStringValueContained((Object) string2, 2131623957)) {
            return string2;
        }
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
    ...
    public static String getSharpness() {
        String string = getString(2131296410);
        String string2 = DataRepository.dataItemGlobal().getString(KEY_QC_SHARPNESS, string);
        if (string.equals(string2) || Util.isStringValueContained((Object) string2, 2131623961)) {
            return string2;
        }
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
    ...
    public static String getAntiBanding() {
        return DataRepository.dataItemGlobal().getString(KEY_ANTIBANDING, getString(getDefaultPreferenceId(2131296443)));
    }

    public static String getStereoDofLevel() {
        return DataRepository.dataItemConfig().getString(KEY_CAMERA_STEREO, getString(2131296658));
    }
    ...
    public static boolean isEvAdjustable() {
        ...
        String string = instance.getString(KEY_QC_EXPOSURETIME, getString(2131296566));
        String string2 = instance.getString(KEY_QC_ISO, getString(2131296426));
        if (b.ia()) {
            return string.equals(getString(2131296566));
        }
        if (string.equals(getString(2131296566)) || string2.equals(getString(2131296426))) {
            z = true;
        }
        return z;
    }
    ...
    public static boolean isPopupTipBeautyIntroEnable() {
        if (!b.hV() || DataRepository.dataItemGlobal().getBoolean(KEY_POPUP_TIP_BEAUTY_INTRO_CLICKED, false) || DataRepository.dataItemGlobal().getInt(KEY_POPUP_TIP_BEAUTY_INTRO_SHOW_TIMES, 0) >= 3) {
            return false;
        }
        return true;
    }
    ...
    public static boolean isUltraWideLDCEnabled() {
        return DataRepository.dataItemGlobal().getBoolean(KEY_ULTRA_WIDE_LDC, getBool(2131689493));
    }

    public static boolean isUltraWideVideoLDCEnabled() {
        return DataRepository.dataItemGlobal().getBoolean(KEY_ULTRA_WIDE_VIDEO_LDC, getBool(2131689493));
    }

    public static boolean isNormalWideLDCEnabled() {
        return DataRepository.dataItemGlobal().getBoolean(KEY_NORMAL_WIDE_LDC, getBool(2131689494));
    }

    public static String getCustomWatermark() {
        return DataRepository.dataItemGlobal().getString(KEY_CUSTOM_WATERMARK, getString(2131296905));
    }

    public static String getDefaultWatermarkStr() {
        return getString(2131296905);
    }
    ...
    public static boolean isLiveStickerInternalChannel() {
        return DataRepository.dataItemGlobal().getBoolean(KEY_LIVE_STICKER_INTERNAL, getBool(2131689489));
    }
    ...
    public static void setLiveModuleClicked() {
        DataRepository.dataItemGlobal().editor().putBoolean(KEY_LIVE_MODULE_CLICKED, true).apply();
    }
    ...
    public static boolean isHangGestureOpen() {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:22:0x0042 A:{RETURN} */
    /* JADX WARNING: Removed duplicated region for block: B:21:0x0041 A:{RETURN} */
    public static boolean isLiveBeautyModeKey(java.lang.String r5) {
        /*
    ...
    L_0x0008:
        r0 = -1;
        r2 = r5.hashCode();
        r3 = -2110473153; // 0xffffffff8234bc3f float:-1.3278335E-37 double:NaN;
        r4 = 1;
        if (r2 == r3) goto L_0x0032;
    L_0x0013:
        r3 = 175697132; // 0xa78ecec float:1.1985326E-32 double:8.6805917E-316;
        if (r2 == r3) goto L_0x0028;
    L_0x0018:
        r3 = 1771202045; // 0x699265fd float:2.21231E25 double:8.750900823E-315;
    ...
    L_0x0043:
        return r4;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.camera.CameraSettings.isLiveBeautyModeKey(java.lang.String):boolean");
    }

    public static long getExposureTime() {
        CameraSettingPreferences instance = CameraSettingPreferences.instance();
        String string = getString(2131296566);
        if (ModuleManager.isManualModule()) {
