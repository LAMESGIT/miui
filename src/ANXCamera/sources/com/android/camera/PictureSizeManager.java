...
public class PictureSizeManager {
    ...
    public static String[] getEntries() {
        if (ModuleManager.isPortraitModule() && CameraSettings.isBackCamera() && DataRepository.dataItemFeature().fB()) {
            return new String[]{CameraSettings.getString(2131296327)};
        } else if (b.gp()) {
            return new String[]{CameraSettings.getString(2131296327), CameraSettings.getString(2131296328), CameraSettings.getString(2131296329)};
        } else if (DataRepository.dataItemFeature().fh()) {
            return new String[]{CameraSettings.getString(2131296327), CameraSettings.getString(2131296328), CameraSettings.getString(2131296330)};
        } else {
            return new String[]{CameraSettings.getString(2131296327), CameraSettings.getString(2131296328)};
        }
    }
