...
public class XMPNormalizer {
    ...
    private static void migrateAudioCopyright(XMPMeta xMPMeta, XMPNode xMPNode) {
        try {
            ...
            if (findSchemaNode != null) {
                if (findSchemaNode.hasChildren()) {
                    ...
                    if (lookupLanguageItem < 0) {
                        ...
                        xMPMeta2.setLocalizedText(XMPConst.NS_DC, "rights", "", XMPConst.X_DEFAULT, findSchemaNode.getChild(1).getValue(), null);
                    ...
                    if (indexOf >= 0) {
                        ...
                        if (!value2.substring(indexOf).equals(value)) {
                            StringBuilder stringBuilder = new StringBuilder();
                            stringBuilder.append(value2.substring(0, indexOf));
            ...
            xMPMeta3.setLocalizedText(XMPConst.NS_DC, "rights", "", XMPConst.X_DEFAULT, stringBuilder3.toString(), null);
            xMPNode.getParent().removeChild(xMPNode);
        } catch (XMPException e) {
        }
    }
