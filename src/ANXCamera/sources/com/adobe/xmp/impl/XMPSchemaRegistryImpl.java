...
public final class XMPSchemaRegistryImpl implements XMPConst, XMPSchemaRegistry {
    ...
    public synchronized String registerNamespace(String str, String str2) throws XMPException {
        ...
        ParameterAsserts.assertPrefix(str22);
        ...
        if (Utils.isXMLNameNS(str22.substring(0, str22.length() - 1))) {
            String str3 = (String) this.namespaceToPrefixMap.get(str);
            String str4 = (String) this.prefixToNamespaceMap.get(str22);
            if (str3 != null) {
                return str3;
            }
            if (str4 != null) {
                Object obj = str22;
                int i = 1;
                while (this.prefixToNamespaceMap.containsKey(obj)) {
                    stringBuilder = new StringBuilder();
                    stringBuilder.append(str22.substring(0, str22.length() - 1));
            ...
            this.prefixToNamespaceMap.put(str22, str);
            this.namespaceToPrefixMap.put(str, str22);
            return str22;
        }
