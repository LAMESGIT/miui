            ...
            while (true) {
                ...
                switch (readTag) {
                    ...
                    case 18:
                        ...
                        fieldDescriptorProtoArr = new FieldDescriptorProto[(readTag + i)];
                        if (i != 0) {
                            System.arraycopy(this.field, 0, fieldDescriptorProtoArr, 0, i);
                        }
                        while (i < fieldDescriptorProtoArr.length - 1) {
                            fieldDescriptorProtoArr[i] = new FieldDescriptorProto();
                            codedInputByteBufferNano.readMessage(fieldDescriptorProtoArr[i]);
                    ...
                    case 26:
                        ...
                        DescriptorProto[] descriptorProtoArr = new DescriptorProto[(readTag + i)];
                        if (i != 0) {
                            System.arraycopy(this.nestedType, 0, descriptorProtoArr, 0, i);
                        }
                        while (i < descriptorProtoArr.length - 1) {
                            descriptorProtoArr[i] = new DescriptorProto();
                            codedInputByteBufferNano.readMessage(descriptorProtoArr[i]);
                            codedInputByteBufferNano.readTag();
                            i++;
                        }
                        descriptorProtoArr[i] = new DescriptorProto();
                    ...
                    case 34:
                        ...
                        EnumDescriptorProto[] enumDescriptorProtoArr = new EnumDescriptorProto[(readTag + i)];
                        if (i != 0) {
                            System.arraycopy(this.enumType, 0, enumDescriptorProtoArr, 0, i);
                        }
                        while (i < enumDescriptorProtoArr.length - 1) {
                            enumDescriptorProtoArr[i] = new EnumDescriptorProto();
                            codedInputByteBufferNano.readMessage(enumDescriptorProtoArr[i]);
                            codedInputByteBufferNano.readTag();
                            i++;
                        }
                        enumDescriptorProtoArr[i] = new EnumDescriptorProto();
                    ...
                    case 42:
                        ...
                        ExtensionRange[] extensionRangeArr = new ExtensionRange[(readTag + i)];
                        if (i != 0) {
                            System.arraycopy(this.extensionRange, 0, extensionRangeArr, 0, i);
                        }
                        while (i < extensionRangeArr.length - 1) {
                            extensionRangeArr[i] = new ExtensionRange();
                            codedInputByteBufferNano.readMessage(extensionRangeArr[i]);
                            codedInputByteBufferNano.readTag();
                            i++;
                        }
                        extensionRangeArr[i] = new ExtensionRange();
                    ...
                    case 50:
                        ...
                        fieldDescriptorProtoArr = new FieldDescriptorProto[(readTag + i)];
                        if (i != 0) {
                            System.arraycopy(this.extension, 0, fieldDescriptorProtoArr, 0, i);
                        }
                        while (i < fieldDescriptorProtoArr.length - 1) {
                            fieldDescriptorProtoArr[i] = new FieldDescriptorProto();
                            codedInputByteBufferNano.readMessage(fieldDescriptorProtoArr[i]);
                    ...
                    case 66:
                        ...
                        OneofDescriptorProto[] oneofDescriptorProtoArr = new OneofDescriptorProto[(readTag + i)];
                        if (i != 0) {
                            System.arraycopy(this.oneofDecl, 0, oneofDescriptorProtoArr, 0, i);
                        }
                        while (i < oneofDescriptorProtoArr.length - 1) {
                            oneofDescriptorProtoArr[i] = new OneofDescriptorProto();
                            codedInputByteBufferNano.readMessage(oneofDescriptorProtoArr[i]);
                            codedInputByteBufferNano.readTag();
                            i++;
                        }
                        oneofDescriptorProtoArr[i] = new OneofDescriptorProto();
                    ...
                    case 74:
                        ...
                        ReservedRange[] reservedRangeArr = new ReservedRange[(readTag + i)];
                        if (i != 0) {
                            System.arraycopy(this.reservedRange, 0, reservedRangeArr, 0, i);
                        }
                        while (i < reservedRangeArr.length - 1) {
                            reservedRangeArr[i] = new ReservedRange();
                            codedInputByteBufferNano.readMessage(reservedRangeArr[i]);
                            codedInputByteBufferNano.readTag();
                            i++;
                        }
                        reservedRangeArr[i] = new ReservedRange();
                    ...
                    case 82:
                        ...
                        String[] strArr = new String[(readTag + i)];
                        if (i != 0) {
                            System.arraycopy(this.reservedName, 0, strArr, 0, i);
                        }
                        while (i < strArr.length - 1) {
                            strArr[i] = codedInputByteBufferNano.readString();
                            codedInputByteBufferNano.readTag();
                            i++;
                        }
                        strArr[i] = codedInputByteBufferNano.readString();
        ...
        public EnumDescriptorProto mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
            while (true) {
                ...
                if (readTag == 10) {
                    ...
                    EnumValueDescriptorProto[] enumValueDescriptorProtoArr = new EnumValueDescriptorProto[(readTag + i)];
                    if (i != 0) {
                        System.arraycopy(this.value, 0, enumValueDescriptorProtoArr, 0, i);
                    }
                    while (i < enumValueDescriptorProtoArr.length - 1) {
                        enumValueDescriptorProtoArr[i] = new EnumValueDescriptorProto();
                        codedInputByteBufferNano.readMessage(enumValueDescriptorProtoArr[i]);
                        codedInputByteBufferNano.readTag();
                        i++;
                    }
                    enumValueDescriptorProtoArr[i] = new EnumValueDescriptorProto();
                    ...
                    EnumReservedRange[] enumReservedRangeArr = new EnumReservedRange[(readTag + i)];
                    if (i != 0) {
                        System.arraycopy(this.reservedRange, 0, enumReservedRangeArr, 0, i);
                    }
                    while (i < enumReservedRangeArr.length - 1) {
                        enumReservedRangeArr[i] = new EnumReservedRange();
                        codedInputByteBufferNano.readMessage(enumReservedRangeArr[i]);
                        codedInputByteBufferNano.readTag();
                        i++;
                    }
                    enumReservedRangeArr[i] = new EnumReservedRange();
        ...
        public EnumOptions mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
            while (true) {
                ...
                if (readTag == 10) {
                    ...
                    UninterpretedOption[] uninterpretedOptionArr = new UninterpretedOption[(readTag + i)];
                    if (i != 0) {
                        System.arraycopy(this.uninterpretedOption, 0, uninterpretedOptionArr, 0, i);
                    }
                    while (i < uninterpretedOptionArr.length - 1) {
                        uninterpretedOptionArr[i] = new UninterpretedOption();
                        codedInputByteBufferNano.readMessage(uninterpretedOptionArr[i]);
                        codedInputByteBufferNano.readTag();
                        i++;
                    }
                    uninterpretedOptionArr[i] = new UninterpretedOption();
            ...
            while (true) {
                ...
                switch (readTag) {
                    ...
                    case 90:
                        ...
                        UpgradedOption[] upgradedOptionArr = new UpgradedOption[(readTag + i)];
                        if (i != 0) {
                            System.arraycopy(this.upgradedOption, 0, upgradedOptionArr, 0, i);
                        }
                        while (i < upgradedOptionArr.length - 1) {
                            upgradedOptionArr[i] = new UpgradedOption();
                            codedInputByteBufferNano.readMessage(upgradedOptionArr[i]);
                            codedInputByteBufferNano.readTag();
                            i++;
                        }
                        upgradedOptionArr[i] = new UpgradedOption();
            ...
            while (true) {
                ...
                switch (readTag) {
                    ...
                    case 26:
                        ...
                        String[] strArr = new String[(readTag + i)];
                        if (i != 0) {
                            System.arraycopy(this.dependency, 0, strArr, 0, i);
                        }
                        while (i < strArr.length - 1) {
                            strArr[i] = codedInputByteBufferNano.readString();
                            codedInputByteBufferNano.readTag();
                    ...
                    case 34:
                        ...
                        DescriptorProto[] descriptorProtoArr = new DescriptorProto[(readTag + i)];
                        if (i != 0) {
                            System.arraycopy(this.messageType, 0, descriptorProtoArr, 0, i);
                        }
                        while (i < descriptorProtoArr.length - 1) {
                            descriptorProtoArr[i] = new DescriptorProto();
                            codedInputByteBufferNano.readMessage(descriptorProtoArr[i]);
                    ...
                    case 50:
                        ...
                        ServiceDescriptorProto[] serviceDescriptorProtoArr = new ServiceDescriptorProto[(readTag + i)];
                        if (i != 0) {
                            System.arraycopy(this.service, 0, serviceDescriptorProtoArr, 0, i);
                        }
                        while (i < serviceDescriptorProtoArr.length - 1) {
                            serviceDescriptorProtoArr[i] = new ServiceDescriptorProto();
                            codedInputByteBufferNano.readMessage(serviceDescriptorProtoArr[i]);
                            codedInputByteBufferNano.readTag();
                            i++;
                        }
                        serviceDescriptorProtoArr[i] = new ServiceDescriptorProto();
                    ...
                    case 58:
                        ...
                        FieldDescriptorProto[] fieldDescriptorProtoArr = new FieldDescriptorProto[(readTag + i)];
                        if (i != 0) {
                            System.arraycopy(this.extension, 0, fieldDescriptorProtoArr, 0, i);
                        }
                        while (i < fieldDescriptorProtoArr.length - 1) {
                    ...
                    case 80:
                        ...
                        iArr = new int[(readTag + i)];
                        if (i != 0) {
                            System.arraycopy(this.publicDependency, 0, iArr, 0, i);
                        }
                    ...
                    case 82:
                        ...
                        iArr2 = new int[(i2 + i)];
                        if (i != 0) {
                            System.arraycopy(this.publicDependency, 0, iArr2, 0, i);
                        }
                        while (i < iArr2.length) {
                            iArr2[i] = codedInputByteBufferNano.readInt32();
                            i++;
                        }
                    ...
                    case 88:
                        ...
                        iArr = new int[(readTag + i)];
                        if (i != 0) {
                            System.arraycopy(this.weakDependency, 0, iArr, 0, i);
                        }
                        while (i < iArr.length - 1) {
                            iArr[i] = codedInputByteBufferNano.readInt32();
                            codedInputByteBufferNano.readTag();
                    ...
                    case 90:
                        ...
                        iArr2 = new int[(i2 + i)];
                        if (i != 0) {
                            System.arraycopy(this.weakDependency, 0, iArr2, 0, i);
                        }
                        while (i < iArr2.length) {
                            iArr2[i] = codedInputByteBufferNano.readInt32();
                            i++;
        ...
        public FileDescriptorSet mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
            while (true) {
                ...
                if (readTag == 10) {
                    ...
                    FileDescriptorProto[] fileDescriptorProtoArr = new FileDescriptorProto[(readTag + i)];
                    if (i != 0) {
                        System.arraycopy(this.file, 0, fileDescriptorProtoArr, 0, i);
                    }
                    while (i < fileDescriptorProtoArr.length - 1) {
                        fileDescriptorProtoArr[i] = new FileDescriptorProto();
                        codedInputByteBufferNano.readMessage(fileDescriptorProtoArr[i]);
                        codedInputByteBufferNano.readTag();
                        i++;
                    }
                    fileDescriptorProtoArr[i] = new FileDescriptorProto();
            ...
            while (true) {
                ...
                switch (readTag) {
                    ...
                    case 7994:
                        ...
                        UninterpretedOption[] uninterpretedOptionArr = new UninterpretedOption[(readTag + position)];
                        if (position != 0) {
                            System.arraycopy(this.uninterpretedOption, 0, uninterpretedOptionArr, 0, position);
                        }
                        while (position < uninterpretedOptionArr.length - 1) {
                            uninterpretedOptionArr[position] = new UninterpretedOption();
                            codedInputByteBufferNano.readMessage(uninterpretedOptionArr[position]);
                            codedInputByteBufferNano.readTag();
                            position++;
                        }
                        uninterpretedOptionArr[position] = new UninterpretedOption();
            ...
            public Annotation mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
                while (true) {
                    ...
                    if (readTag == 8) {
                        ...
                        int[] iArr = new int[(readTag + i)];
                        if (i != 0) {
                            System.arraycopy(this.path, 0, iArr, 0, i);
                        }
                        while (i < iArr.length - 1) {
                            iArr[i] = codedInputByteBufferNano.readInt32();
                            codedInputByteBufferNano.readTag();
                        ...
                        if (i != 0) {
                            System.arraycopy(this.path, 0, iArr2, 0, i);
                        }
                        while (i < iArr2.length) {
                            iArr2[i] = codedInputByteBufferNano.readInt32();
                            i++;
        ...
        public GeneratedCodeInfo mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
            while (true) {
                ...
                if (readTag == 10) {
                    ...
                    Annotation[] annotationArr = new Annotation[(readTag + i)];
                    if (i != 0) {
                        System.arraycopy(this.annotation, 0, annotationArr, 0, i);
                    }
                    while (i < annotationArr.length - 1) {
                        annotationArr[i] = new Annotation();
                        codedInputByteBufferNano.readMessage(annotationArr[i]);
                        codedInputByteBufferNano.readTag();
                        i++;
                    }
                    annotationArr[i] = new Annotation();
        ...
        public MessageOptions mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
            while (true) {
                ...
                if (readTag == 8) {
                    ...
                    strArr = new String[(readTag + i)];
                    if (i != 0) {
                        System.arraycopy(this.experimentalJavaMessageInterface, 0, strArr, 0, i);
                    }
                    while (i < strArr.length - 1) {
                        strArr[i] = codedInputByteBufferNano.readString();
                        codedInputByteBufferNano.readTag();
                    ...
                    strArr = new String[(readTag + i)];
                    if (i != 0) {
                        System.arraycopy(this.experimentalJavaBuilderInterface, 0, strArr, 0, i);
                    }
                    while (i < strArr.length - 1) {
                        strArr[i] = codedInputByteBufferNano.readString();
                        codedInputByteBufferNano.readTag();
                    ...
                    strArr = new String[(readTag + i)];
                    if (i != 0) {
                        System.arraycopy(this.experimentalJavaInterfaceExtends, 0, strArr, 0, i);
                    }
                    while (i < strArr.length - 1) {
                        strArr[i] = codedInputByteBufferNano.readString();
                        codedInputByteBufferNano.readTag();
        ...
        public ServiceDescriptorProto mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
            while (true) {
                ...
                if (readTag == 10) {
                    ...
                    MethodDescriptorProto[] methodDescriptorProtoArr = new MethodDescriptorProto[(readTag + i)];
                    if (i != 0) {
                        System.arraycopy(this.method, 0, methodDescriptorProtoArr, 0, i);
                    }
                    while (i < methodDescriptorProtoArr.length - 1) {
                        methodDescriptorProtoArr[i] = new MethodDescriptorProto();
                        codedInputByteBufferNano.readMessage(methodDescriptorProtoArr[i]);
                        codedInputByteBufferNano.readTag();
                        i++;
                    }
                    methodDescriptorProtoArr[i] = new MethodDescriptorProto();
                    ...
                    StreamDescriptorProto[] streamDescriptorProtoArr = new StreamDescriptorProto[(readTag + i)];
                    if (i != 0) {
                        System.arraycopy(this.stream, 0, streamDescriptorProtoArr, 0, i);
                    }
                    while (i < streamDescriptorProtoArr.length - 1) {
                        streamDescriptorProtoArr[i] = new StreamDescriptorProto();
                        codedInputByteBufferNano.readMessage(streamDescriptorProtoArr[i]);
                        codedInputByteBufferNano.readTag();
                        i++;
                    }
                    streamDescriptorProtoArr[i] = new StreamDescriptorProto();
            ...
            public Location mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
                while (true) {
                    ...
                    if (readTag == 8) {
                        ...
                        iArr = new int[(readTag + i)];
                        if (i != 0) {
                            System.arraycopy(this.span, 0, iArr, 0, i);
                        }
                        while (i < iArr.length - 1) {
                            iArr[i] = codedInputByteBufferNano.readInt32();
                            codedInputByteBufferNano.readTag();
                        ...
                        iArr2 = new int[(i2 + i)];
                        if (i != 0) {
                            System.arraycopy(this.span, 0, iArr2, 0, i);
                        }
                        while (i < iArr2.length) {
                            iArr2[i] = codedInputByteBufferNano.readInt32();
                            i++;
                        ...
                        String[] strArr = new String[(readTag + i)];
                        if (i != 0) {
                            System.arraycopy(this.leadingDetachedComments, 0, strArr, 0, i);
                        }
                        while (i < strArr.length - 1) {
                            strArr[i] = codedInputByteBufferNano.readString();
                            codedInputByteBufferNano.readTag();
        ...
        public SourceCodeInfo mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
            while (true) {
                ...
                if (readTag == 10) {
                    ...
                    Location[] locationArr = new Location[(readTag + i)];
                    if (i != 0) {
                        System.arraycopy(this.location, 0, locationArr, 0, i);
                    }
                    while (i < locationArr.length - 1) {
                        locationArr[i] = new Location();
                        codedInputByteBufferNano.readMessage(locationArr[i]);
                        codedInputByteBufferNano.readTag();
                        i++;
                    }
                    locationArr[i] = new Location();
        ...
        public UninterpretedOption mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
            while (true) {
                ...
                if (readTag == 18) {
                    ...
                    NamePart[] namePartArr = new NamePart[(readTag + i)];
                    if (i != 0) {
                        System.arraycopy(this.name, 0, namePartArr, 0, i);
                    }
                    while (i < namePartArr.length - 1) {
                        namePartArr[i] = new NamePart();
                        codedInputByteBufferNano.readMessage(namePartArr[i]);
                        codedInputByteBufferNano.readTag();
                        i++;
                    }
                    namePartArr[i] = new NamePart();
