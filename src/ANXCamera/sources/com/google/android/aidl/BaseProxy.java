...
public abstract class BaseProxy implements IInterface {
    ...
    /* Access modifiers changed, original: protected */
    public Parcel transactAndReadException(int e, Parcel parcel) throws RemoteException {
        Parcel obtain = Parcel.obtain();
        try {
...
/*
Method generation error in method: com.google.android.aidl.BaseProxy.transactAndReadException(int, android.os.Parcel):android.os.Parcel, dex: 
jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0019: INVOKE  (wrap: android.os.Parcel
  ?: MERGE  (r5_1 android.os.Parcel) = (r5_0 'parcel' android.os.Parcel), (r0_0 'obtain' android.os.Parcel)) android.os.Parcel.recycle():void type: VIRTUAL in method: com.google.android.aidl.BaseProxy.transactAndReadException(int, android.os.Parcel):android.os.Parcel, dex: 
...
Caused by: jadx.core.utils.exceptions.CodegenException: Error generate insn: ?: MERGE  (r5_1 android.os.Parcel) = (r5_0 'parcel' android.os.Parcel), (r0_0 'obtain' android.os.Parcel) in method: com.google.android.aidl.BaseProxy.transactAndReadException(int, android.os.Parcel):android.os.Parcel, dex: 
	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:228)
