...
public class CameraInstance {
    ...
    public synchronized void focusAtPoint(float r4, float r5, float r6) {
        ...
        r3 = this;
        monitor-enter(r3);
        r0 = r3.mCameraDevice;	 Catch:{ all -> 0x00c6 }
        if (r0 != 0) goto L_0x000e;
    L_0x0005:
        r4 = "CameraInstance";
        r5 = "Error: focus after release.";
        com.ss.android.ttve.common.TELogUtil.e(r4, r5);	 Catch:{ all -> 0x00c6 }
        monitor-exit(r3);
        return;
    L_0x000e:
        r0 = r3.mCameraDevice;	 Catch:{ all -> 0x00c6 }
        r0 = r0.getParameters();	 Catch:{ all -> 0x00c6 }
        r3.mParams = r0;	 Catch:{ all -> 0x00c6 }
        r0 = r3.mParams;	 Catch:{ all -> 0x00c6 }
        r0 = r0.getMaxNumMeteringAreas();	 Catch:{ all -> 0x00c6 }
        if (r0 <= 0) goto L_0x00bd;
    L_0x001e:
        r0 = r3.mRotation;	 Catch:{ all -> 0x00c6 }
        r4 = r3.calculateTapArea(r4, r5, r6, r0);	 Catch:{ all -> 0x00c6 }
        r5 = "CameraInstance";
        r6 = "FocusAreas: [%d, %d, %d, %d]";
        r0 = 4;
        r0 = new java.lang.Object[r0];	 Catch:{ all -> 0x00c6 }
        r1 = 0;
        r2 = r4.left;	 Catch:{ all -> 0x00c6 }
        r2 = java.lang.Integer.valueOf(r2);	 Catch:{ all -> 0x00c6 }
        r0[r1] = r2;	 Catch:{ all -> 0x00c6 }
        r1 = 1;
        r2 = r4.top;	 Catch:{ all -> 0x00c6 }
        r2 = java.lang.Integer.valueOf(r2);	 Catch:{ all -> 0x00c6 }
        r0[r1] = r2;	 Catch:{ all -> 0x00c6 }
        r1 = 2;
        r2 = r4.right;	 Catch:{ all -> 0x00c6 }
        r2 = java.lang.Integer.valueOf(r2);	 Catch:{ all -> 0x00c6 }
        r0[r1] = r2;	 Catch:{ all -> 0x00c6 }
        r1 = 3;
        r2 = r4.bottom;	 Catch:{ all -> 0x00c6 }
        r2 = java.lang.Integer.valueOf(r2);	 Catch:{ all -> 0x00c6 }
        r0[r1] = r2;	 Catch:{ all -> 0x00c6 }
        r6 = java.lang.String.format(r6, r0);	 Catch:{ all -> 0x00c6 }
        com.ss.android.ttve.common.TELogUtil.d(r5, r6);	 Catch:{ all -> 0x00c6 }
        r5 = new java.util.ArrayList;	 Catch:{ all -> 0x00c6 }
        r5.<init>();	 Catch:{ all -> 0x00c6 }
        r6 = new android.hardware.Camera$Area;	 Catch:{ all -> 0x00c6 }
        r0 = 1000; // 0x3e8 float:1.401E-42 double:4.94E-321;
        r6.<init>(r4, r0);	 Catch:{ all -> 0x00c6 }
        r5.add(r6);	 Catch:{ all -> 0x00c6 }
        r4 = r3.mCameraDevice;	 Catch:{ Exception -> 0x00a1 }
        r4.cancelAutoFocus();	 Catch:{ Exception -> 0x00a1 }
        r4 = android.os.Build.BRAND;	 Catch:{ Exception -> 0x00a1 }
        r6 = "Multilaser";
        r4 = android.text.TextUtils.equals(r4, r6);	 Catch:{ Exception -> 0x00a1 }
    ...
    L_0x0074:
        ...
        if (r4 != 0) goto L_0x0083;
    L_0x007e:
        r4 = r3.mParams;	 Catch:{ Exception -> 0x00a1 }
    ...
    L_0x0083:
        ...
        r4 = r3.mCameraDevice;	 Catch:{ Exception -> 0x00a1 }
        r5 = r3.mParams;	 Catch:{ Exception -> 0x00a1 }
        r4.setParameters(r5);	 Catch:{ Exception -> 0x00a1 }
        r4 = r3.mCameraDevice;	 Catch:{ Exception -> 0x00a1 }
        r5 = new com.ss.android.ttve.utils.CameraInstance$3;	 Catch:{ Exception -> 0x00a1 }
    ...
    L_0x00a1:
        r4 = move-exception;
        r5 = "CameraInstance";
        r6 = new java.lang.StringBuilder;	 Catch:{ all -> 0x00c6 }
        r6.<init>();	 Catch:{ all -> 0x00c6 }
        r0 = "Error: focusAtPoint failed: ";
        r6.append(r0);	 Catch:{ all -> 0x00c6 }
        r4 = r4.toString();	 Catch:{ all -> 0x00c6 }
        r6.append(r4);	 Catch:{ all -> 0x00c6 }
        r4 = r6.toString();	 Catch:{ all -> 0x00c6 }
        com.ss.android.ttve.common.TELogUtil.e(r5, r4);	 Catch:{ all -> 0x00c6 }
    L_0x00bc:
        goto L_0x00c4;
    L_0x00bd:
        r4 = "CameraInstance";
        r5 = "The device does not support metering areas...";
        com.ss.android.ttve.common.TELogUtil.i(r4, r5);	 Catch:{ all -> 0x00c6 }
    L_0x00c4:
        monitor-exit(r3);
        return;
    L_0x00c6:
