...
public class FileUtils {
    ...
    public static void unZip(java.lang.String r5, java.lang.String r6) throws com.ss.android.ugc.effectmanager.common.exception.UnzipException {
        /*
        r0 = 0;
        r1 = new java.util.zip.ZipInputStream;	 Catch:{ IOException -> 0x00af, all -> 0x00ac }
        r2 = new java.io.BufferedInputStream;	 Catch:{ IOException -> 0x00af, all -> 0x00ac }
        r3 = new java.io.FileInputStream;	 Catch:{ IOException -> 0x00af, all -> 0x00ac }
        r3.<init>(r5);	 Catch:{ IOException -> 0x00af, all -> 0x00ac }
        r2.<init>(r3);	 Catch:{ IOException -> 0x00af, all -> 0x00ac }
        r1.<init>(r2);	 Catch:{ IOException -> 0x00af, all -> 0x00ac }
    L_0x0012:
        r5 = r1.getNextEntry();	 Catch:{ IOException -> 0x00a8, all -> 0x00a6 }
        if (r5 == 0) goto L_0x0092;
    L_0x0018:
        r2 = r5.getName();	 Catch:{ IOException -> 0x00a8, all -> 0x00a6 }
        r5 = r5.isDirectory();	 Catch:{ IOException -> 0x00a8, all -> 0x00a6 }
        if (r5 == 0) goto L_0x003f;
    L_0x0022:
        r5 = new java.io.File;	 Catch:{ IOException -> 0x00a8, all -> 0x00a6 }
        r3 = new java.lang.StringBuilder;	 Catch:{ IOException -> 0x00a8, all -> 0x00a6 }
        r3.<init>();	 Catch:{ IOException -> 0x00a8, all -> 0x00a6 }
        r3.append(r6);	 Catch:{ IOException -> 0x00a8, all -> 0x00a6 }
        r4 = java.io.File.separator;	 Catch:{ IOException -> 0x00a8, all -> 0x00a6 }
        r3.append(r4);	 Catch:{ IOException -> 0x00a8, all -> 0x00a6 }
        r3.append(r2);	 Catch:{ IOException -> 0x00a8, all -> 0x00a6 }
        r2 = r3.toString();	 Catch:{ IOException -> 0x00a8, all -> 0x00a6 }
        r5.<init>(r2);	 Catch:{ IOException -> 0x00a8, all -> 0x00a6 }
        r5.mkdirs();	 Catch:{ IOException -> 0x00a8, all -> 0x00a6 }
        goto L_0x008d;
    L_0x003f:
        r5 = new java.io.File;	 Catch:{ IOException -> 0x00a8, all -> 0x00a6 }
        r3 = new java.lang.StringBuilder;	 Catch:{ IOException -> 0x00a8, all -> 0x00a6 }
        ...
        r2 = r3.toString();	 Catch:{ IOException -> 0x00a8, all -> 0x00a6 }
        r5.<init>(r2);	 Catch:{ IOException -> 0x00a8, all -> 0x00a6 }
        r2 = r5.exists();	 Catch:{ IOException -> 0x00a8, all -> 0x00a6 }
        if (r2 == 0) goto L_0x0062;
    L_0x005e:
        r5.delete();	 Catch:{ IOException -> 0x00a8, all -> 0x00a6 }
        goto L_0x0069;
    L_0x0062:
        r2 = r5.getParentFile();	 Catch:{ IOException -> 0x00a8, all -> 0x00a6 }
        r2.mkdirs();	 Catch:{ IOException -> 0x00a8, all -> 0x00a6 }
    L_0x0069:
        r5.createNewFile();	 Catch:{ IOException -> 0x00a8, all -> 0x00a6 }
        r2 = new java.io.BufferedOutputStream;	 Catch:{ IOException -> 0x00a8, all -> 0x00a6 }
        r3 = new java.io.FileOutputStream;	 Catch:{ IOException -> 0x00a8, all -> 0x00a6 }
        r3.<init>(r5);	 Catch:{ IOException -> 0x00a8, all -> 0x00a6 }
        r2.<init>(r3);	 Catch:{ IOException -> 0x00a8, all -> 0x00a6 }
        r5 = 2048; // 0x800 float:2.87E-42 double:1.0118E-320;
        r5 = new byte[r5];	 Catch:{ IOException -> 0x0090, all -> 0x008e }
    L_0x007a:
        r0 = r1.read(r5);	 Catch:{ IOException -> 0x0090, all -> 0x008e }
        r3 = -1;
        if (r0 == r3) goto L_0x0086;
    L_0x0081:
        r3 = 0;
        r2.write(r5, r3, r0);	 Catch:{ IOException -> 0x0090, all -> 0x008e }
        goto L_0x007a;
    L_0x0086:
        r2.flush();	 Catch:{ IOException -> 0x0090, all -> 0x008e }
        r2.close();	 Catch:{ IOException -> 0x0090, all -> 0x008e }
        r0 = r2;
    L_0x008d:
        goto L_0x0012;
    L_0x008e:
    ...
    L_0x00af:
        ...
        r2 = r0;
    L_0x00b1:
        r6 = new com.ss.android.ugc.effectmanager.common.exception.UnzipException;	 Catch:{ all -> 0x00bb }
        r5 = r5.getMessage();	 Catch:{ all -> 0x00bb }
