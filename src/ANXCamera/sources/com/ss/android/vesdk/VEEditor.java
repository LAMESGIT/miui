...
public class VEEditor implements OnFrameAvailableListener {
    ...
    public void setOnErrorListener(@NonNull final VECommonCallback vECommonCallback) {
        AnonymousClass4 anonymousClass4 = new TECommonCallback() {
    ...
    public void setOnInfoListener(@NonNull final VECommonCallback vECommonCallback) {
        AnonymousClass5 anonymousClass5 = new TECommonCallback() {
            public void onCallback(int i, int i2, float f, String str) {
                if (i != 4103) {
                    vECommonCallback.onCallback(i, i2, f, str);
    ...
    /* JADX WARNING: Missing block: B:31:0x0086, code skipped:
            return 0;
     */
    public int enableReversePlay(boolean r6) {
        /*
        r5 = this;
        monitor-enter(r5);
        r0 = r5.mReverseDone;	 Catch:{ all -> 0x008b }
    ...
    L_0x0005:
        ...
        return r6;
    L_0x0009:
        r0 = r5.mResManager;	 Catch:{ all -> 0x008b }
        if (r0 == 0) goto L_0x0087;
    L_0x000d:
        r0 = r5.mResManager;	 Catch:{ all -> 0x008b }
        r0 = r0.mReverseVideoPath;	 Catch:{ all -> 0x008b }
        if (r0 == 0) goto L_0x0087;
    L_0x0013:
        r0 = r5.mResManager;	 Catch:{ all -> 0x008b }
        r0 = r0.mReverseVideoPath;	 Catch:{ all -> 0x008b }
        r0 = r0.length;	 Catch:{ all -> 0x008b }
        if (r0 > 0) goto L_0x001b;
    L_0x001a:
        goto L_0x0087;
    L_0x001b:
        r0 = r5.mVideoEditor;	 Catch:{ all -> 0x008b }
        r0.stop();	 Catch:{ all -> 0x008b }
    ...
    L_0x0027:
        r0 = r5.mResManager;	 Catch:{ all -> 0x008b }
        r0 = r0.mVideoPaths;	 Catch:{ all -> 0x008b }
    L_0x002b:
        r1 = r5.mVideoEditor;	 Catch:{ all -> 0x008b }
        r2 = 0;
        r0 = r1.updateTrackClips(r2, r2, r0);	 Catch:{ all -> 0x008b }
        if (r0 == 0) goto L_0x004c;
    L_0x0034:
        r6 = "VEEditor";
        r1 = new java.lang.StringBuilder;	 Catch:{ all -> 0x008b }
        r1.<init>();	 Catch:{ all -> 0x008b }
        r2 = "Create Scene failed, ret = ";
        r1.append(r2);	 Catch:{ all -> 0x008b }
        r1.append(r0);	 Catch:{ all -> 0x008b }
        r1 = r1.toString();	 Catch:{ all -> 0x008b }
        com.ss.android.ttve.common.TELogUtil.e(r6, r1);	 Catch:{ all -> 0x008b }
        monitor-exit(r5);	 Catch:{ all -> 0x008b }
        return r0;
    L_0x004c:
        r0 = r5.mVideoEditor;	 Catch:{ all -> 0x008b }
        r1 = r5.mBReversePlay;	 Catch:{ all -> 0x008b }
        r3 = 1;
    ...
    L_0x0055:
        r1 = r2;
    L_0x0056:
        r0.updateTrackFilter(r2, r2, r1);	 Catch:{ all -> 0x008b }
        r0 = r5.mVideoEditor;	 Catch:{ all -> 0x008b }
        r0.createTimeline();	 Catch:{ all -> 0x008b }
        r0 = r5.mVideoEditor;	 Catch:{ all -> 0x008b }
        r1 = r5.mVideoEditor;	 Catch:{ all -> 0x008b }
        r1 = r1.getDuration();	 Catch:{ all -> 0x008b }
        r4 = r5.mModelsDir;	 Catch:{ all -> 0x008b }
        r0.prepareEngine(r2, r1, r2, r4);	 Catch:{ all -> 0x008b }
        r0 = com.ss.android.vesdk.VEEditor.SEEK_MODE.EDITOR_SEEK_FLAG_LastSeek;	 Catch:{ all -> 0x008b }
        r5.seek(r2, r0);	 Catch:{ all -> 0x008b }
        r5.mBReversePlay = r6;	 Catch:{ all -> 0x008b }
        if (r6 == 0) goto L_0x0085;
    L_0x0074:
        r6 = new com.ss.android.vesdk.keyvaluepair.VEKeyValue;	 Catch:{ all -> 0x008b }
        r6.<init>();	 Catch:{ all -> 0x008b }
        r0 = "iesve_veeditor_time_effect_id";
        r1 = "reverse";
        r6.add(r0, r1);	 Catch:{ all -> 0x008b }
        r0 = "iesve_veeditor_time_effect";
        com.ss.android.ttve.monitor.MonitorUtils.monitorStatistics(r0, r3, r6);	 Catch:{ all -> 0x008b }
    L_0x0085:
        monitor-exit(r5);	 Catch:{ all -> 0x008b }
        return r2;
    L_0x0087:
        r6 = -105; // 0xffffffffffffff97 float:NaN double:NaN;
        monitor-exit(r5);	 Catch:{ all -> 0x008b }
        return r6;
    L_0x008b:
        r6 = move-exception;
        ...
        throw r6;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ss.android.vesdk.VEEditor.enableReversePlay(boolean):int");
    }
    ...
    /* JADX WARNING: Missing block: B:13:0x002e, code skipped:
            return -100;
     */
    public int addAudioTrack(java.lang.String r11, int r12, int r13, boolean r14) {
        /*
        r10 = this;
        monitor-enter(r10);
        r0 = "VEEditor";
        r1 = "addAudioTrack...";
        com.ss.android.ttve.common.TELogUtil.w(r0, r1);	 Catch:{ all -> 0x002f }
        r0 = android.text.TextUtils.isEmpty(r11);	 Catch:{ all -> 0x002f }
        r1 = -100;
    ...
    L_0x0010:
        ...
        return r1;
    L_0x0012:
        if (r13 <= r12) goto L_0x002d;
    L_0x0014:
        if (r12 >= 0) goto L_0x0017;
    L_0x0016:
        goto L_0x002d;
    L_0x0017:
        r0 = "iesve_veeditor_import_music";
        r1 = 1;
        r2 = 0;
        com.ss.android.ttve.monitor.MonitorUtils.monitorStatistics(r0, r1, r2);	 Catch:{ all -> 0x002f }
        r3 = r10.mVideoEditor;	 Catch:{ all -> 0x002f }
        r5 = 0;
        r6 = r13 - r12;
        r4 = r11;
        r7 = r12;
        r8 = r13;
        r9 = r14;
        r11 = r3.addAudioTrack(r4, r5, r6, r7, r8, r9);	 Catch:{ all -> 0x002f }
        monitor-exit(r10);	 Catch:{ all -> 0x002f }
        return r11;
    L_0x002d:
        monitor-exit(r10);	 Catch:{ all -> 0x002f }
    ...
    L_0x002f:
        ...
        throw r11;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ss.android.vesdk.VEEditor.addAudioTrack(java.lang.String, int, int, boolean):int");
    }
    ...
    /* JADX WARNING: Missing block: B:18:0x002d, code skipped:
            return -100;
     */
    public int addAudioTrack(java.lang.String r8, int r9, int r10, int r11, int r12, boolean r13) {
        /*
        r7 = this;
        monitor-enter(r7);
        r0 = "VEEditor";
        r1 = "addAudioTrack...";
        com.ss.android.ttve.common.TELogUtil.i(r0, r1);	 Catch:{ all -> 0x002e }
        r0 = android.text.TextUtils.isEmpty(r8);	 Catch:{ all -> 0x002e }
        r1 = -100;
        if (r0 == 0) goto L_0x0012;
    L_0x0010:
    ...
    L_0x0016:
        goto L_0x002c;
    L_0x0017:
        if (r12 <= r11) goto L_0x002a;
    L_0x0019:
        if (r11 >= 0) goto L_0x001c;
    L_0x001b:
        goto L_0x002a;
    L_0x001c:
        r0 = r7.mVideoEditor;	 Catch:{ all -> 0x002e }
        r1 = r8;
        r2 = r11;
        r3 = r12;
        r4 = r9;
        r5 = r10;
        r6 = r13;
        r8 = r0.addAudioTrack(r1, r2, r3, r4, r5, r6);	 Catch:{ all -> 0x002e }
        monitor-exit(r7);	 Catch:{ all -> 0x002e }
        return r8;
    L_0x002a:
        monitor-exit(r7);	 Catch:{ all -> 0x002e }
    ...
    L_0x002e:
        ...
        throw r8;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ss.android.vesdk.VEEditor.addAudioTrack(java.lang.String, int, int, int, int, boolean):int");
    }
    ...
    /* JADX WARNING: Missing block: B:21:0x0035, code skipped:
            return -100;
     */
    public int addAudioTrack(java.lang.String r12, int r13, int r14, int r15, int r16, boolean r17, int r18, int r19) {
        /*
        r11 = this;
        r1 = r11;
        r0 = r13;
        ...
        r2 = "VEEditor";
        r3 = "addAudioTrack...";
        com.ss.android.ttve.common.TELogUtil.i(r2, r3);	 Catch:{ all -> 0x0036 }
        r2 = android.text.TextUtils.isEmpty(r12);	 Catch:{ all -> 0x0036 }
        r3 = -100;
    ...
    L_0x0021:
        goto L_0x0032;
    L_0x0022:
        r2 = r1.mVideoEditor;	 Catch:{ all -> 0x0036 }
        r3 = r12;
        r6 = r0;
        r8 = r17;
        r9 = r18;
        r10 = r19;
        r0 = r2.addAudioTrack(r3, r4, r5, r6, r7, r8, r9, r10);	 Catch:{ all -> 0x0036 }
        monitor-exit(r11);	 Catch:{ all -> 0x0036 }
        return r0;
    L_0x0032:
        monitor-exit(r11);	 Catch:{ all -> 0x0036 }
    ...
    L_0x0036:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ss.android.vesdk.VEEditor.addAudioTrack(java.lang.String, int, int, int, int, boolean, int, int):int");
    }

    /* JADX WARNING: Missing block: B:13:0x0023, code skipped:
            return -100;
     */
    public int updateAudioTrack(int r8, int r9, int r10, boolean r11) {
        /*
        r7 = this;
        monitor-enter(r7);
        r0 = "VEEditor";
        r1 = "updateAudioTrack...";
        com.ss.android.ttve.common.TELogUtil.w(r0, r1);	 Catch:{ all -> 0x0024 }
        r0 = -100;
    ...
    L_0x0012:
        goto L_0x0022;
    L_0x0013:
        r0 = r7.mVideoEditor;	 Catch:{ all -> 0x0024 }
        r2 = 0;
        r3 = r10 - r9;
        r1 = r8;
        r4 = r9;
        r5 = r10;
        r6 = r11;
        r8 = r0.updateAudioTrack(r1, r2, r3, r4, r5, r6);	 Catch:{ all -> 0x0024 }
        monitor-exit(r7);	 Catch:{ all -> 0x0024 }
        return r8;
    L_0x0022:
        monitor-exit(r7);	 Catch:{ all -> 0x0024 }
    ...
    L_0x0024:
        ...
        throw r8;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ss.android.vesdk.VEEditor.updateAudioTrack(int, int, int, boolean):int");
    }
    ...
    /* JADX WARNING: Missing block: B:18:0x0029, code skipped:
            return -100;
     */
    public int updateAudioTrack(int r8, int r9, int r10, int r11, int r12, boolean r13) {
        /*
        r7 = this;
        monitor-enter(r7);
        r0 = "VEEditor";
        r1 = "updateAudioTrack...";
        com.ss.android.ttve.common.TELogUtil.i(r0, r1);	 Catch:{ all -> 0x002a }
        r0 = -100;
        if (r8 >= 0) goto L_0x000e;
    L_0x000c:
    ...
    L_0x0017:
        goto L_0x0026;
    L_0x0018:
        r0 = r7.mVideoEditor;	 Catch:{ all -> 0x002a }
        r1 = r8;
        r2 = r11;
        r3 = r12;
        r4 = r9;
        r5 = r10;
        r6 = r13;
        r8 = r0.updateAudioTrack(r1, r2, r3, r4, r5, r6);	 Catch:{ all -> 0x002a }
        monitor-exit(r7);	 Catch:{ all -> 0x002a }
        return r8;
    L_0x0026:
        monitor-exit(r7);	 Catch:{ all -> 0x002a }
    ...
    L_0x002a:
        ...
        throw r8;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ss.android.vesdk.VEEditor.updateAudioTrack(int, int, int, int, int, boolean):int");
    }
    ...
    /* JADX WARNING: Missing block: B:27:0x0038, code skipped:
            return -100;
     */
    public int updateAudioTrack(int r12, int r13, int r14, int r15, int r16, boolean r17, int r18, int r19) {
        /*
        r11 = this;
        r1 = r11;
        r0 = r13;
        ...
        r2 = "VEEditor";
        r3 = "updateAudioTrack...";
        com.ss.android.ttve.common.TELogUtil.i(r2, r3);	 Catch:{ all -> 0x0039 }
        r2 = -100;
    ...
    L_0x0026:
        goto L_0x0033;
    L_0x0027:
        r2 = r1.mVideoEditor;	 Catch:{ all -> 0x0039 }
        r3 = r12;
        r6 = r0;
        r8 = r17;
        r0 = r2.updateAudioTrack(r3, r4, r5, r6, r7, r8, r9, r10);	 Catch:{ all -> 0x0039 }
        monitor-exit(r11);	 Catch:{ all -> 0x0039 }
        return r0;
    L_0x0033:
        monitor-exit(r11);	 Catch:{ all -> 0x0039 }
    ...
    L_0x0039:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ss.android.vesdk.VEEditor.updateAudioTrack(int, int, int, int, int, boolean, int, int):int");
    }
